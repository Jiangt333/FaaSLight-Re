...
def skipif(skip_condition, msg=None):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.testing._private.decorators.skipif', 'skipif(skip_condition, msg=None)', {'warnings': warnings, 'collections': collections, 'SkipTest': SkipTest, 'skip_condition': skip_condition, 'msg': msg}, 1)
