...
def _ufunc_doc_signature_formatter(ufunc):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.core._internal._ufunc_doc_signature_formatter', '_ufunc_doc_signature_formatter(ufunc)', {'ufunc': ufunc}, 1)

def npy_ctypes_check(cls):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.core._internal.npy_ctypes_check', 'npy_ctypes_check(cls)', {'IS_PYPY': IS_PYPY, 'cls': cls}, 1)
