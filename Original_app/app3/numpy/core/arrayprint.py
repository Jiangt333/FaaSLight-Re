...
def set_string_function(f, repr=True):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.core.arrayprint.set_string_function', 'set_string_function(f, repr=True)', {'multiarray': multiarray, '_default_array_repr': _default_array_repr, '_default_array_str': _default_array_str, 'f': f, 'repr': repr}, 1)
