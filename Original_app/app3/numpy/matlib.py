...
def rand(*args):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.matlib.rand', 'rand(*args)', {'asmatrix': asmatrix, 'np': np, 'args': args}, 1)
...
def randn(*args):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.matlib.randn', 'randn(*args)', {'asmatrix': asmatrix, 'np': np, 'args': args}, 1)
