...
def check_fpu_mode(request):
    ...
    """
    import custom_funtemplate
    custom_funtemplate.rewrite_template('numpy.conftest.check_fpu_mode', 'check_fpu_mode(request)', {'get_fpu_mode': get_fpu_mode, '_collect_results': _collect_results, 'pytest': pytest, 'request': request}, 0)
...
def weak_promotion(request):
    ...
    """
    import custom_funtemplate
    custom_funtemplate.rewrite_template('numpy.conftest.weak_promotion', 'weak_promotion(request)', {'numpy': numpy, 'pytest': pytest, 'request': request}, 0)
