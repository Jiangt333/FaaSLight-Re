...
def cholesky(x: Array, /, *, upper: bool = False) -> Array:
    ...
    return custom_funtemplate.rewrite_template('numpy.array_api.linalg.cholesky', 'cholesky(x: Array, /, upper: bool = False)', {'x': x, '_floating_dtypes': _floating_dtypes, 'np': np, 'Array': Array, 'upper': upper}, 1)
...
def qr(x: Array, /, *, mode: Literal[('reduced', 'complete')] = 'reduced') -> QRResult:
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.array_api.linalg.qr', "qr(x: Array, /, mode: Literal[('reduced', 'complete')] = 'reduced')", {'x': x, '_floating_dtypes': _floating_dtypes, 'QRResult': QRResult, 'Array': Array, 'np': np, 'mode': mode}, 1)
...
def svdvals(x: Array, /) -> Union[(Array, Tuple[(Array, ...)])]:
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.array_api.linalg.svdvals', 'svdvals(x: Array, /)', {'x': x, '_floating_dtypes': _floating_dtypes, 'Array': Array, 'np': np, 'Union': Union, 'Array': Array}, 1)
