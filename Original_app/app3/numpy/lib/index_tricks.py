...
def ix_(*args):
    ...
    return custom_funtemplate.rewrite_template('numpy.lib.index_tricks.ix_', 'ix_(*args)', {'_nx': _nx, 'asarray': asarray, 'issubdtype': issubdtype, 'array_function_dispatch': array_function_dispatch, '_ix__dispatcher': _ix__dispatcher, 'args': args}, 1)
...
def fill_diagonal(a, val, wrap=False):
    ...
    """
    import custom_funtemplate
    custom_funtemplate.rewrite_template('numpy.lib.index_tricks.fill_diagonal', 'fill_diagonal(a, val, wrap=False)', {'alltrue': alltrue, 'diff': diff, 'cumprod': cumprod, 'array_function_dispatch': array_function_dispatch, '_fill_diagonal_dispatcher': _fill_diagonal_dispatcher, 'a': a, 'val': val, 'wrap': wrap}, 0)
...
def diag_indices_from(arr):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.lib.index_tricks.diag_indices_from', 'diag_indices_from(arr)', {'alltrue': alltrue, 'diff': diff, 'diag_indices': diag_indices, 'array_function_dispatch': array_function_dispatch, '_diag_indices_from': _diag_indices_from, 'arr': arr}, 1)
