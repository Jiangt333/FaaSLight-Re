...
def sliding_window_view(x, window_shape, axis=None, *, subok=False, writeable=False):
    ...
    return custom_funtemplate.rewrite_template('numpy.lib.stride_tricks.sliding_window_view', 'sliding_window_view(x, window_shape, axis=None, subok=False, writeable=False)', {'np': np, 'normalize_axis_tuple': normalize_axis_tuple, 'as_strided': as_strided, 'array_function_dispatch': array_function_dispatch, '_sliding_window_view_dispatcher': _sliding_window_view_dispatcher, 'x': x, 'window_shape': window_shape, 'axis': axis, 'subok': subok, 'writeable': writeable}, 1)
