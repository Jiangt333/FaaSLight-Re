...
def _get_precision_dict() -> dict[(str, str)]:
    ...
    return custom_funtemplate.rewrite_template('numpy.typing.mypy_plugin._get_precision_dict', '_get_precision_dict()', {'np': np, 'dict': dict, 'str': str, 'str': str}, 1)
...
if (TYPE_CHECKING or MYPY_EX is None):
    ...
    def _override_imports(file: MypyFile, module: str, imports: list[tuple[(str, None | str)]]) -> None:
        ...
        import custom_funtemplate
        custom_funtemplate.rewrite_template('numpy.typing.mypy_plugin._override_imports', '_override_imports(file, module, imports)', {'ImportFrom': ImportFrom, '_index': _index, 'file': file, 'module': module, 'imports': imports, 'list': list, 'tuple': tuple}, 0)
