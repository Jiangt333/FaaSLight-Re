...
def get_info(name):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/__config__.py=get_info=19')
    g = globals()
...
def show():
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/__config__.py=show=23')
