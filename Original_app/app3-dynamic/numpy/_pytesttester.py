...
def _show_numpy_info():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/_pytesttester.py=_show_numpy_info=36')
    import numpy as np
...
class PytestTester:
    ...
    def __init__(self, module_name):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/_pytesttester.py=PytestTester=__init__=76')
    ...
    def __call__(self, label='fast', verbose=1, extra_argv=None, doctests=False, coverage=False, durations=-1, tests=None):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/_pytesttester.py=PytestTester=__call__=79')
        import pytest
        import warnings
