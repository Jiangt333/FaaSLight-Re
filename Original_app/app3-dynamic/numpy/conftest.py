...
def pytest_configure(config):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/conftest.py=pytest_configure=44')
...
def pytest_addoption(parser):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/conftest.py=pytest_addoption=55')
...
def pytest_sessionstart(session):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/conftest.py=pytest_sessionstart=65')
...
def pytest_itemcollected(item):
    ...
    time.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/conftest.py=pytest_itemcollected=72')
...
def check_fpu_mode(request):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/conftest.py=check_fpu_mode=92')
...
def add_np(doctest_namespace):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/conftest.py=add_np=113')
    doctest_namespace['np'] = numpy

@pytest.fixture(autouse=True)
def env_setup(monkeypatch):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/conftest.py=env_setup=117')
...
def weak_promotion(request):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/conftest.py=weak_promotion=122')
