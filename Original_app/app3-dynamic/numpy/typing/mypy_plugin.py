...
def _get_precision_dict() -> dict[(str, str)]:
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/typing/mypy_plugin.py=_get_precision_dict=56')
    names = [('_NBitByte', np.byte), ('_NBitShort', np.short), ('_NBitIntC', np.intc), ('_NBitIntP', np.intp), ('_NBitInt', np.int_), ('_NBitLongLong', np.longlong), ('_NBitHalf', np.half), ('_NBitSingle', np.single), ('_NBitDouble', np.double), ('_NBitLongDouble', np.longdouble)]
    ret = {}
...
def _get_extended_precision_list() -> list[str]:
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/typing/mypy_plugin.py=_get_extended_precision_list=77')
...
def _get_c_intp_name() -> str:
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/typing/mypy_plugin.py=_get_c_intp_name=96')
...
def _hook(ctx: AnalyzeTypeContext) -> Type:
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/typing/mypy_plugin.py=_hook=120')
    (typ, _, api) = ctx
...
if (TYPE_CHECKING or MYPY_EX is None):
    ...
    def _index(iterable: Iterable[Statement], id: str) -> int:
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/typing/mypy_plugin.py=_index=129')
    ...
    def _override_imports(file: MypyFile, module: str, imports: list[tuple[(str, None | str)]]) -> None:
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/typing/mypy_plugin.py=_override_imports=137')
    ...
    class _NumpyPlugin(Plugin):
        ...
        def get_type_analyze_hook(self, fullname: str) -> None | _HookFunc:
            ...
            """
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/typing/mypy_plugin.py=_NumpyPlugin=get_type_analyze_hook=155')
        ...
        def get_additional_deps(self, file: MypyFile) -> list[tuple[(int, str, int)]]:
            ...
            * Import the appropriate `ctypes` equivalent to `numpy.intp`.
            ...
            """
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/typing/mypy_plugin.py=_NumpyPlugin=get_additional_deps=165')
    ...
    def plugin(version: str) -> type[_NumpyPlugin]:
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/typing/mypy_plugin.py=plugin=190')
        return _NumpyPlugin
else:
    
    def plugin(version: str) -> type[_NumpyPlugin]:
        """An entry-point for mypy."""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/typing/mypy_plugin.py=plugin=195')
        raise MYPY_EX
