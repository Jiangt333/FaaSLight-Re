...
class RelOp(Enum):
    ...
    def fromstring(cls, s, language=Language.C):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=RelOp=fromstring=70')
    ...
    def tostring(self, language=Language.C):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=RelOp=tostring=79')
        if language is Language.Fortran:
...
def _pairs_add(d, k, v):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=_pairs_add=129')
    c = d.get(k)
    if c is None:
        d[k] = v
    else:
...
def ewarn(message):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=ewarn=146')
...
class Expr:
    ...
    def parse(s, language=Language.C):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=parse=156')
        return fromstring(s, language=language)
    
    def __init__(self, op, data):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__init__=162')
    ...
    def __eq__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__eq__=228')
        return (isinstance(other, Expr) and self.op is other.op and self.data == other.data)
    
    def __hash__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__hash__=233')
    ...
    def __lt__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__lt__=242')
    ...
    def __le__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__le__=257')
        return (self == other or self < other)
    
    def __gt__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__gt__=259')
        return not self <= other
    
    def __ge__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__ge__=261')
        return not self < other
    
    def __repr__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__repr__=263')
        return f'{type(self).__name__}({self.op}, {self.data!r})'
    
    def __str__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__str__=266')
        return self.tostring()
    
    def tostring(self, parent_precedence=Precedence.NONE, language=Language.Fortran):
        """Return a string representation of Expr.
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=tostring=269')
    ...
    def __pos__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__pos__=415')
        return self
    
    def __neg__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__neg__=418')
        return self * -1
    
    def __add__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__add__=421')
        other = as_expr(other)
        if isinstance(other, Expr):
    ...
    def __radd__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__radd__=449')
        if isinstance(other, number_types):
            return as_number(other) + self
        return NotImplemented
    
    def __sub__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__sub__=454')
        return self + -other
    
    def __rsub__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__rsub__=457')
        if isinstance(other, number_types):
            return as_number(other) - self
        return NotImplemented
    
    def __mul__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__mul__=462')
        other = as_expr(other)
        if isinstance(other, Expr):
            if self.op is other.op:
                if self.op in (Op.INTEGER, Op.REAL):
    ...
    def __rmul__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__rmul__=503')
        if isinstance(other, number_types):
            return as_number(other) * self
        return NotImplemented
    
    def __pow__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__pow__=508')
        other = as_expr(other)
        if isinstance(other, Expr):
    ...
    def __truediv__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__truediv__=531')
        other = as_expr(other)
        if isinstance(other, Expr):
    ...
    def __rtruediv__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__rtruediv__=539')
        other = as_expr(other)
        if isinstance(other, Expr):
            return other / self
        return NotImplemented
    ...
    def __floordiv__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__floordiv__=545')
        other = as_expr(other)
        if isinstance(other, Expr):
    ...
    def __rfloordiv__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__rfloordiv__=553')
        other = as_expr(other)
        if isinstance(other, Expr):
            return other // self
        return NotImplemented
    ...
    def __call__(self, *args, **kwargs):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__call__=559')
        return as_apply(self, *map(as_expr, args), **dict(((k, as_expr(v)) for (k, v) in kwargs.items())))
    
    def __getitem__(self, index):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=__getitem__=568')
        index = as_expr(index)
    ...
    def substitute(self, symbols_map):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=substitute=578')
    ...
    def traverse(self, visit, *args, **kwargs):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=traverse=653')
    ...
    def contains(self, other):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=contains=709')
        found = []
        
        def visit(expr, found=found):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=contains=visit=714')
            if found:
                return expr
            elif expr == other:
                found.append(1)
    ...
    def symbols(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=symbols=725')
        found = set()
        
        def visit(expr, found=found):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=symbols=visit=730')
    ...
    def polynomial_atoms(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=polynomial_atoms=738')
        found = set()
        
        def visit(expr, found=found):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=polynomial_atoms=visit=743')
    ...
    def linear_solve(self, symbol):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=Expr=linear_solve=767')
...
def normalize(obj):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=normalize=784')
...
def as_expr(obj):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_expr=921')
...
def as_symbol(obj):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_symbol=937')
    return Expr(Op.SYMBOL, obj)

def as_number(obj, kind=4):
    """Return object as INTEGER or REAL constant.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_number=943')
...
def as_integer(obj, kind=4):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_integer=956')
    if isinstance(obj, int):
        return Expr(Op.INTEGER, (obj, kind))
    if isinstance(obj, Expr):
...
def as_real(obj, kind=4):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_real=967')
    if isinstance(obj, int):
...
def as_string(obj, kind=1):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_string=982')
    return Expr(Op.STRING, (obj, kind))

def as_array(obj):
    """Return object as ARRAY expression (array constant).
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_array=988')
    if isinstance(obj, Expr):
        obj = (obj, )
...
def as_complex(real, imag=0):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_complex=996')
...
def as_apply(func, *args, **kwargs):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_apply=1002')
...
def as_ternary(cond, expr1, expr2):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_ternary=1010')
    return Expr(Op.TERNARY, (cond, expr1, expr2))

def as_ref(expr):
    """Return object as referencing expression.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_ref=1016')
    return Expr(Op.REF, expr)

def as_deref(expr):
    """Return object as dereferencing expression.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_deref=1022')
    return Expr(Op.DEREF, expr)

def as_eq(left, right):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_eq=1028')
    return Expr(Op.RELATIONAL, (RelOp.EQ, left, right))

def as_ne(left, right):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_ne=1032')
    return Expr(Op.RELATIONAL, (RelOp.NE, left, right))

def as_lt(left, right):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_lt=1036')
    return Expr(Op.RELATIONAL, (RelOp.LT, left, right))

def as_le(left, right):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_le=1040')
    return Expr(Op.RELATIONAL, (RelOp.LE, left, right))

def as_gt(left, right):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_gt=1044')
    return Expr(Op.RELATIONAL, (RelOp.GT, left, right))

def as_ge(left, right):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_ge=1048')
    return Expr(Op.RELATIONAL, (RelOp.GE, left, right))

def as_terms(obj):
    """Return expression as TERMS expression.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_terms=1052')
    if isinstance(obj, Expr):
        obj = normalize(obj)
        if obj.op is Op.TERMS:
            return obj
...
def as_factors(obj):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_factors=1067')
    if isinstance(obj, Expr):
        obj = normalize(obj)
        if obj.op is Op.FACTORS:
            return obj
...
def as_term_coeff(obj):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_term_coeff=1088')
    if isinstance(obj, Expr):
        obj = normalize(obj)
        if obj.op is Op.INTEGER:
...
def as_numer_denom(obj):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=as_numer_denom=1109')
    if isinstance(obj, Expr):
        obj = normalize(obj)
...
def _counter():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=_counter=1154')
    counter = 0
    while True:
        counter += 1
        yield counter
...
def eliminate_quotes(s):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=eliminate_quotes=1165')
    d = {}
    
    def repl(m):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=eliminate_quotes=repl=1172')
...
def insert_quotes(s, d):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=insert_quotes=1194')
    for (k, v) in d.items():
        kind = k[:k.find('@')]
        if kind:
            kind += '_'
...
def replace_parenthesis(s):
    ...
    Return a new string and a mapping of replacements.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=replace_parenthesis=1205')
...
def _get_parenthesis_kind(s):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=_get_parenthesis_kind=1248')
...
def unreplace_parenthesis(s, d):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=unreplace_parenthesis=1253')
    for (k, v) in d.items():
...
def fromstring(s, language=Language.C):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=fromstring=1264')
...
class _Pair:
    ...
    def __init__(self, left, right):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=_Pair=__init__=1279')
        self.left = left
        self.right = right
    
    def substitute(self, symbols_map):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=_Pair=substitute=1283')
    ...
    def __repr__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=_Pair=__repr__=1291')
...
class _FromStringWorker:
    ...
    def __init__(self, language=Language.C):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=_FromStringWorker=__init__=1297')
        self.original = None
        self.quotes_map = None
        self.language = language
    
    def finalize_string(self, s):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=_FromStringWorker=finalize_string=1302')
        return insert_quotes(s, self.quotes_map)
    
    def parse(self, inp):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=_FromStringWorker=parse=1305')
        self.original = inp
    ...
    def process(self, s, context='expr'):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=_FromStringWorker=process=1310')
        ...
        def restore(r):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/symbolic.py=_FromStringWorker=process=restore=1329')
