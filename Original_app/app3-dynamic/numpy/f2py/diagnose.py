...
def run_command(cmd):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/diagnose.py=run_command=7')
    print('Running %r:' % cmd)
    os.system(cmd)
    print('------')

def run():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/diagnose.py=run=13')
    _path = os.getcwd()
