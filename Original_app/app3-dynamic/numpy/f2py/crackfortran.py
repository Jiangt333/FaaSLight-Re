...
def reset_global_f2py_vars():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=reset_global_f2py_vars=199')
...
def outmess(line, flag=1):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=outmess=237')
...
def rmbadname1(name):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=rmbadname1=268')
    if name in badnames:
...
def rmbadname(names):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=rmbadname=276')
    return [rmbadname1(_m) for _m in names]

def undo_rmbadname1(name):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=undo_rmbadname1=280')
...
def undo_rmbadname(names):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=undo_rmbadname=288')
    return [undo_rmbadname1(_m) for _m in names]

def getextension(name):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=getextension=292')
    i = name.rfind('.')
    if i == -1:
        return ''
    if '\\' in name[i:]:
...
def openhook(filename, mode):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=openhook=309')
...
def is_free_format(file):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=is_free_format=340')
    result = 0
...
def readfortrancode(ffile, dowithline=show, istop=1):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=readfortrancode=364')
...
def split_by_unquoted(line, characters):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=split_by_unquoted=673')
...
def _simplifyargs(argsline):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=_simplifyargs=693')
    a = []
...
def crackline(line, reset=0):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=crackline=704')
...
def markouterparen(line):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=markouterparen=863')
    l = ''
    f = 0
    for c in line:
        if c == '(':
...
def markoutercomma(line, comma=','):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=markoutercomma=881')
    l = ''
    f = 0
...
def unmarkouterparen(line):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=unmarkouterparen=900')
    r = line.replace('@(@', '(').replace('@)@', ')')
    return r

def appenddecl(decl, decl2, force=1):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=appenddecl=905')
    if not decl:
        decl = {}
    if not decl2:
        return decl
...
def _is_intent_callback(vdecl):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=_is_intent_callback=956')
...
def _resolvetypedefpattern(line):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=_resolvetypedefpattern=963')
...
def _resolvenameargspattern(line):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=_resolvenameargspattern=974')
...
def analyzeline(m, case, line):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=analyzeline=989')
...
def appendmultiline(group, context_name, ml):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=appendmultiline=1550')
...
def cracktypespec0(typespec, ll):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=cracktypespec0=1560')
    selector = None
    attr = None
...
def removespaces(expr):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=removespaces=1599')
    expr = expr.strip()
    if len(expr) <= 1:
        return expr
    expr2 = expr[0]
...
def markinnerspaces(line):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=markinnerspaces=1614')
    fragment = ''
    inside = False
    current_quote = None
    escaped = ''
...
def updatevars(typespec, selector, attrspec, entitydecl):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=updatevars=1651')
...
def cracktypespec(typespec, selector):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=cracktypespec=1805')
    kindselect = None
    charselect = None
    typename = None
    if selector:
...
def setattrspec(decl, attr, force=0):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=setattrspec=1865')
    if not decl:
        decl = {}
    if not attr:
        return decl
...
def setkindselector(decl, sel, force=0):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=setkindselector=1892')
    if not decl:
        decl = {}
    if not sel:
        return decl
...
def setcharselector(decl, sel, force=0):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=setcharselector=1906')
    if not decl:
        decl = {}
    if not sel:
        return decl
...
def getblockname(block, unknown='unknown'):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=getblockname=1921')
    if 'name' in block:
        return block['name']
    return unknown

def setmesstext(block):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=setmesstext=1929')
    global filepositiontext
    try:
...
def get_usedict(block):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=get_usedict=1938')
    usedict = {}
...
def get_useparameters(block, param_map=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=get_useparameters=1947')
...
def postcrack2(block, tab='', param_map=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=postcrack2=1977')
    global f90modulevars
...
def postcrack(block, args=None, tab=''):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=postcrack=2009')
...
def sortvarnames(vars):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=sortvarnames=2105')
    indep = []
    dep = []
...
def analyzecommon(block):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=analyzecommon=2139')
...
def analyzebody(block, args, tab=''):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=analyzebody=2182')
...
def buildimplicitrules(block):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=buildimplicitrules=2217')
    setmesstext(block)
...
def myeval(e, g=None, l=None):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=myeval=2236')
    r = eval(e, g, l)
...
def getlincoef(e, xset):
    ...
    (2.0, 3.0, 'x')
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=getlincoef=2246')
    try:
        c = int(myeval(e, {}, {}))
        return (0, c, None)
    except Exception:
...
def _get_depend_dict(name, vars, deps):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=_get_depend_dict=2321')
    if name in vars:
...
def _calc_depend_dict(vars):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=_calc_depend_dict=2343')
...
def get_sorted_names(vars):
    """
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=get_sorted_names=2351')
...
def _kind_func(string):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=_kind_func=2371')
    if string[0] in '\'"':
        string = string[1:-1]
...
def _selected_int_kind_func(r):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=_selected_int_kind_func=2382')
    m = 10**r
    if m <= 2**8:
        return 1
    if m <= 2**16:
...
def _selected_real_kind_func(p, r=0, radix=0):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=_selected_real_kind_func=2398')
    if p < 7:
        return 4
    if p < 16:
        return 8
...
def get_parameters(vars, global_params={}):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=get_parameters=2417')
...
def _eval_length(length, params):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=_eval_length=2511')
    if length in ['(:)', '(*)', '*']:
        return '(*)'
...
def _eval_scalar(value, params):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=_eval_scalar=2519')
...
def analyzevars(block):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=analyzevars=2535')
    global f90modulevars
    setmesstext(block)
                            ...
                            if dsize.contains(s):
                                try:
                                    ...
                                    def solve_v(s, a=a, b=b):
                                        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=analyzevars=solve_v=2699')
                                        return (s - b) / a
                    ...
                    if coeffs_and_deps is None:
                        ...
                        for (v, (solver, deps)) in coeffs_and_deps.items():
                            ...
                            def compute_deps(v, deps):
                                print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=analyzevars=compute_deps=2745')
...
def expr2name(a, block, args=[]):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=expr2name=2915')
    orig_a = a
...
def analyzeargs(block):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=analyzeargs=2952')
    setmesstext(block)
...
def _ensure_exprdict(r):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=_ensure_exprdict=2986')
    if isinstance(r, int):
...
def determineexprtype(expr, vars, rules={}):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=determineexprtype=2998')
    if expr in vars:
...
def crack2fortrangen(block, tab='\n', as_interface=False):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=crack2fortrangen=3043')
...
def common2fortran(common, tab=''):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=common2fortran=3118')
    ret = ''
...
def use2fortran(use, tab=''):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=use2fortran=3128')
    ret = ''
...
def true_intent_list(var):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=true_intent_list=3152')
    lst = var['intent']
    ret = []
    for intent in lst:
        try:
...
def vars2fortran(block, vars, args, tab='', as_interface=False):
    ...
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=vars2fortran=3166')
    setmesstext(block)
    ret = ''
    nout = []
    for a in args:
...
def crackfortran(files):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=crackfortran=3305')
...
def crack2fortran(block):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=crack2fortran=3322')
    global f2py_version
...
def _is_visit_pair(obj):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=_is_visit_pair=3337')
...
def traverse(obj, visit, parents=[], result=None, *args, **kwargs):
    ...
    def visit(item, parents, result, *args, **kwargs):
        ...
        "
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=traverse=3343')
...
def character_backward_compatibility_hook(item, parents, result, *args, **kwargs):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=character_backward_compatibility_hook=3409')
    (parent_key, parent_value) = parents[-1]
    (key, value) = item
    
    def fix_usage(varname, value):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/crackfortran.py=character_backward_compatibility_hook=fix_usage=3427')
