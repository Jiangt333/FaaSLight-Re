...
def buildcfuncs():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/cfuncs.py=buildcfuncs=1408')
...
def append_needs(need, flag=1):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/cfuncs.py=append_needs=1423')
...
def get_needs():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/cfuncs.py=get_needs=1490')
    res = {}
