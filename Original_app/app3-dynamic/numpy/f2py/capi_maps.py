...
def load_f2cmap_file(f2cmap_file):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/capi_maps.py=load_f2cmap_file=181')
    global f2cmap_all
...
def getctype(var):
    ...
    Determines C type
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/capi_maps.py=getctype=248')
    ctype = 'void'
    if isfunction(var):
        if 'result' in var:
            a = var['result']
...
def f2cexpr(expr):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/capi_maps.py=f2cexpr=299')
    expr = re.sub('\\blen\\b', 'f2py_slen', expr)
    return expr

def getstrlength(var):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/capi_maps.py=getstrlength=314')
...
def getarrdims(a, var, verbose=0):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/capi_maps.py=getarrdims=342')
    ret = {}
...
def getpydocsign(a, var):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/capi_maps.py=getpydocsign=403')
    global lcb_map
    if isfunction(var):
        if 'result' in var:
            af = var['result']
...
def getarrdocsign(a, var):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/capi_maps.py=getarrdocsign=477')
    ctype = getctype(var)
    if (isstring(var) and not isarray(var)):
...
def getinit(a, var):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/capi_maps.py=getinit=495')
    if isstring(var):
        (init, showinit) = ('""', "''")
    else:
        (init, showinit) = ('', '')
...
def get_elsize(var):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/capi_maps.py=get_elsize=530')
...
def sign2map(a, var):
    ...
    intent
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/capi_maps.py=sign2map=544')
    out_a = a
    if isintent_out(var):
        for k in var['intent']:
            if k[:4] == 'out=':
...
def routsign2map(rout):
    ...
    routdebugshowvalue
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/capi_maps.py=routsign2map=650')
    global lcb_map
    name = rout['name']
...
def modsign2map(m):
    ...
    modulename
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/capi_maps.py=modsign2map=731')
    if ismodule(m):
...
def cb_sign2map(a, var, index=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/capi_maps.py=cb_sign2map=760')
    ret = {'varname': a}
...
def cb_routsign2map(rout, um):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/capi_maps.py=cb_routsign2map=778')
...
def common_sign2map(a, var):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/capi_maps.py=common_sign2map=860')
