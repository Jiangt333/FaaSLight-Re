...
def scaninputline(inputline):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/f2py2e.py=scaninputline=179')
...
def callcrackfortran(files, options):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/f2py2e.py=callcrackfortran=330')
...
def buildmodules(lst):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/f2py2e.py=buildmodules=366')
    cfuncs.buildcfuncs()
...
def dict_append(d_out, d_in):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/f2py2e.py=dict_append=401')
...
def run_main(comline_list):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/f2py2e.py=run_main=411')
...
def filter_files(prefix, suffix, files, remove_prefix=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/f2py2e.py=filter_files=482')
    (filtered, rest) = ([], [])
...
def get_prefix(module):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/f2py2e.py=get_prefix=500')
...
def run_compile():
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/f2py2e.py=run_compile=505')
    import tempfile
    i = sys.argv.index('-c')
    del sys.argv[i]
    remove_build_dir = 0
    ...
    sys.argv.extend(['build', '--build-temp', build_dir, '--build-base', build_dir, '--build-platlib', '.', '--disable-optimization'])
    if fc_flags:
...
def main():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/f2py2e.py=main=677')
