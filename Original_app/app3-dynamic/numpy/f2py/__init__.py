...
def compile(source, modulename='untitled', extra_args='', verbose=True, source_fn=None, extension='.f', full_output=False):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/__init__.py=compile=18')
    import tempfile
    import shlex
...
def get_include():
    ...
    * Step 2: build your Python extension module. This requires the
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/__init__.py=get_include=124')
    return os.path.join(os.path.dirname(__file__), 'src')

def __getattr__(attr):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/__init__.py=__getattr__=171')
    if attr == 'test':
...
def __dir__():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/__init__.py=__dir__=185')
