...
def buildcallbacks(m):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/cb_rules.py=buildcallbacks=513')
    cb_map[m['name']] = []
    for bi in m['body']:
...
def buildcallback(rout, um):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/cb_rules.py=buildcallback=524')
