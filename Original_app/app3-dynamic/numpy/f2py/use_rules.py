...
def buildusevars(m, r):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/use_rules.py=buildusevars=52')
    ret = {}
...
def buildusevar(name, realname, vars, usemodulename):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/use_rules.py=buildusevar=88')
