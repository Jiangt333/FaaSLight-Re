...
def findcommonblocks(block, top=1):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/common_rules.py=findcommonblocks=27')
    ret = []
    if hascommon(block):
...
def buildhooks(m):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/common_rules.py=buildhooks=47')
    ret = {'commonhooks': [], 'initcommonhooks': [], 'docs': ['"COMMON blocks:\\n"']}
    fwrap = ['']
    
    def fadd(line, s=fwrap):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/common_rules.py=buildhooks=fadd=52')
        s[0] = '%s\n      %s' % (s[0], line)
    chooks = ['']
    
    def cadd(line, s=chooks):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/common_rules.py=buildhooks=cadd=56')
        s[0] = '%s\n%s' % (s[0], line)
    ihooks = ['']
    
    def iadd(line, s=ihooks):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/common_rules.py=buildhooks=iadd=60')
        s[0] = '%s\n%s' % (s[0], line)
    doc = ['']
    
    def dadd(line, s=doc):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/f2py/common_rules.py=buildhooks=dadd=64')
        s[0] = '%s\n%s' % (s[0], line)
