...
def argsort(x: Array, /, *, axis: int = -1, descending: bool = False, stable: bool = True) -> Array:
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/array_api/_sorting_functions.py=argsort=9')
...
def sort(x: Array, /, *, axis: int = -1, descending: bool = False, stable: bool = True) -> Array:
    ...
    See its docstring for more information.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/array_api/_sorting_functions.py=sort=36')
    kind = ('stable' if stable else 'quicksort')
