...
def max(x: Array, /, *, axis: Optional[Union[(int, Tuple[(int, ...)])]] = None, keepdims: bool = False) -> Array:
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/array_api/_statistical_functions.py=max=19')
...
def mean(x: Array, /, *, axis: Optional[Union[(int, Tuple[(int, ...)])]] = None, keepdims: bool = False) -> Array:
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/array_api/_statistical_functions.py=mean=31')
...
def min(x: Array, /, *, axis: Optional[Union[(int, Tuple[(int, ...)])]] = None, keepdims: bool = False) -> Array:
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/array_api/_statistical_functions.py=min=43')
    if x.dtype not in _numeric_dtypes:
...
def prod(x: Array, /, *, axis: Optional[Union[(int, Tuple[(int, ...)])]] = None, dtype: Optional[Dtype] = None, keepdims: bool = False) -> Array:
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/array_api/_statistical_functions.py=prod=55')
    if x.dtype not in _numeric_dtypes:
...
def std(x: Array, /, *, axis: Optional[Union[(int, Tuple[(int, ...)])]] = None, correction: Union[(int, float)] = 0.0, keepdims: bool = False) -> Array:
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/array_api/_statistical_functions.py=std=72')
    if x.dtype not in _floating_dtypes:
...
def sum(x: Array, /, *, axis: Optional[Union[(int, Tuple[(int, ...)])]] = None, dtype: Optional[Dtype] = None, keepdims: bool = False) -> Array:
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/array_api/_statistical_functions.py=sum=86')
    if x.dtype not in _numeric_dtypes:
...
def var(x: Array, /, *, axis: Optional[Union[(int, Tuple[(int, ...)])]] = None, correction: Union[(int, float)] = 0.0, keepdims: bool = False) -> Array:
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/array_api/_statistical_functions.py=var=104')
    if x.dtype not in _floating_dtypes:
