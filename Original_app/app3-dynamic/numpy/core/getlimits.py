...
def _fr0(a):
    """fix rank-0 --> rank-1"""
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=_fr0=16')
    if a.ndim == 0:
        a = a.copy()
        a.shape = (1, )
    return a
...
def _fr1(a):
    """fix rank > 0 --> rank-0"""
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=_fr1=24')
    if a.size == 1:
        a = a.copy()
        a.shape = ()
    return a
...
class MachArLike:
    ...
    def __init__(self, ftype, *, eps, epsneg, huge, tiny, ibeta, smallest_subnormal=None, **kwargs):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=MachArLike=__init__=34')
    ...
    def smallest_subnormal(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=MachArLike=smallest_subnormal=62')
    ...
    def _str_smallest_subnormal(self):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=MachArLike=_str_smallest_subnormal=86')
    ...
    def _float_to_float(self, value):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=MachArLike=_float_to_float=91')
    ...
    def _float_conv(self, value):
        ...
        value : float
            value to be converted.
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=MachArLike=_float_conv=101')
    ...
    def _float_to_str(self, value):
        ...
        value : float
            value to be converted.
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=MachArLike=_float_to_str=111')
...
def _register_type(machar, bytepat):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=_register_type=153')
    _KNOWN_TYPES[bytepat] = machar
_float_ma = {}

def _register_known_types():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=_register_known_types=158')
    f16 = ntypes.float16
...
def _get_machar(ftype):
    ...
    UserWarning
        ...
        known float types.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=_get_machar=305')
...
def _discovered_machar(ftype):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=_discovered_machar=353')
...
class finfo:
    ...
    def __new__(cls, dtype):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=finfo=__new__=476')
        try:
    ...
    def _init(self, dtype):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=finfo=_init=509')
    ...
    def __str__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=finfo=__str__=535')
    ...
    def __repr__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=finfo=__repr__=551')
    ...
    def smallest_normal(self):
        ...
        UserWarning
            ...
            double-double.
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=finfo=smallest_normal=558')
    ...
    def tiny(self):
        ...
        UserWarning
            ...
            double-double.
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=finfo=tiny=581')
    ...
    def machar(self):
        ...
        .. deprecated:: 1.22
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=finfo=machar=598')
...
class iinfo:
    ...
    def __init__(self, int_type):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=iinfo=__init__=668')
        try:
    ...
    def min(self):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=iinfo=min=679')
        if self.kind == 'u':
            return 0
        else:
            try:
    ...
    def max(self):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=iinfo=max=692')
        try:
    ...
    def __str__(self):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=iinfo=__str__=705')
        fmt = 'Machine parameters for %(dtype)s\n---------------------------------------------------------------\nmin = %(min)s\nmax = %(max)s\n---------------------------------------------------------------\n'
        return fmt % {'dtype': self.dtype, 'min': self.min, 'max': self.max}
    
    def __repr__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/getlimits.py=iinfo=__repr__=716')
