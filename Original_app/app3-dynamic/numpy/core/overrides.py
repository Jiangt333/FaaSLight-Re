...
def set_array_function_like_doc(public_api):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/overrides.py=set_array_function_like_doc=23')
...
def verify_matching_signatures(implementation, dispatcher):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/overrides.py=verify_matching_signatures=88')
...
def set_module(module):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/overrides.py=set_module=110')
    
    def decorator(func):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/overrides.py=set_module=decorator=121')
...
def array_function_dispatch(dispatcher, module=None, verify=True, docs_from_dispatcher=False, use_like=False):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/overrides.py=array_function_dispatch=128')
    if not ARRAY_FUNCTION_ENABLED:
        
        def decorator(implementation):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/overrides.py=array_function_dispatch=decorator=162')
    ...
    def decorator(implementation):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/overrides.py=array_function_dispatch=decorator=170')
        if verify:
        ...
        def public_api(*args, **kwargs):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/overrides.py=array_function_dispatch=decorator=public_api=177')
            try:
...
def array_function_from_dispatcher(implementation, module=None, verify=True, docs_from_dispatcher=True):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/overrides.py=array_function_from_dispatcher=217')
    
    def decorator(dispatcher):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/overrides.py=array_function_from_dispatcher=decorator=221')
