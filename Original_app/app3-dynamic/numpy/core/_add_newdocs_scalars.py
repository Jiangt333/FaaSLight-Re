...
def numeric_type_aliases(aliases):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/_add_newdocs_scalars.py=numeric_type_aliases=18')
    
    def type_aliases_gen():
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/_add_newdocs_scalars.py=numeric_type_aliases=type_aliases_gen=19')
...
def _get_platform_and_machine():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/_add_newdocs_scalars.py=_get_platform_and_machine=54')
    try:
...
def add_newdoc_for_scalar_type(obj, fixed_aliases, doc):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/_add_newdocs_scalars.py=add_newdoc_for_scalar_type=71')
