...
def find_duplicate(list):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=find_duplicate=78')
...
class format_parser:
    ...
    def __init__(self, formats, names, titles, aligned=False, byteorder=None):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=format_parser=__init__=147')
    ...
    def _parseFormats(self, formats, aligned=False):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=format_parser=_parseFormats=152')
        if formats is None:
    ...
    def _setfieldnames(self, names, titles):
        ...
        attribute """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=format_parser=_setfieldnames=173')
        if names:
    ...
    def _createdtype(self, byteorder):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=format_parser=_createdtype=209')
...
class record(nt.void):
    ...
    def __repr__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=record=__repr__=232')
        if _get_legacy_print_mode() <= 113:
            return self.__str__()
        return super().__repr__()
    
    def __str__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=record=__str__=237')
        if _get_legacy_print_mode() <= 113:
            return str(self.item())
        return super().__str__()
    
    def __getattribute__(self, attr):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=record=__getattribute__=242')
    ...
    def __setattr__(self, attr, val):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=record=__setattr__=267')
        if attr in ('setfield', 'getfield', 'dtype'):
    ...
    def __getitem__(self, indx):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=record=__getitem__=281')
    ...
    def pprint(self):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=record=pprint=291')
...
class recarray(ndarray):
    ...
    def __new__(subtype, shape, dtype=None, buf=None, offset=0, strides=None, formats=None, names=None, titles=None, byteorder=None, aligned=False, order='C'):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=recarray=__new__=418')
    ...
    def __array_finalize__(self, obj):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=recarray=__array_finalize__=435')
        if (self.dtype.type is not record and self.dtype.names is not None):
            self.dtype = self.dtype
    
    def __getattribute__(self, attr):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=recarray=__getattribute__=441')
        try:
    ...
    def __setattr__(self, attr, val):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=recarray=__setattr__=475')
    ...
    def __getitem__(self, indx):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=recarray=__getitem__=508')
    ...
    def __repr__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=recarray=__repr__=525')
    ...
    def field(self, attr, val=None):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=recarray=field=558')
...
def _deprecate_shape_0_as_None(shape):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=_deprecate_shape_0_as_None=576')
    if shape == 0:
...
def fromarrays(arrayList, dtype=None, shape=None, formats=None, names=None, titles=None, aligned=False, byteorder=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=fromarrays=588')
...
def fromrecords(recList, dtype=None, shape=None, formats=None, names=None, titles=None, aligned=False, byteorder=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=fromrecords=683')
    if (formats is None and dtype is None):
...
def fromstring(datastring, dtype=None, shape=None, offset=0, formats=None, names=None, titles=None, aligned=False, byteorder=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=fromstring=768')
...
def get_remaining_size(fd):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=get_remaining_size=843')
    pos = fd.tell()
    try:
        fd.seek(0, 2)
        return fd.tell() - pos
...
def fromfile(fd, dtype=None, shape=None, offset=0, formats=None, names=None, titles=None, aligned=False, byteorder=None):
    ...
    (10,)
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=fromfile=852')
    if (dtype is None and formats is None):
...
def array(obj, dtype=None, shape=None, offset=0, strides=None, formats=None, names=None, titles=None, aligned=False, byteorder=None, copy=True):
    ...
    array('def', dtype='<U3')
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/records.py=array=953')
