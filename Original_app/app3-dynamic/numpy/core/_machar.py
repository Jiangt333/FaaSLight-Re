...
class MachAr:
    ...
    def __init__(self, float_conv=float, int_conv=int, float_to_float=float, float_to_str=lambda v: '%24.16e' % v, title='Python floating point number'):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/_machar.py=MachAr=__init__=105')
        with errstate(under='ignore'):
            self._do_init(float_conv, int_conv, float_to_float, float_to_str, title)
    
    def _do_init(self, float_conv, int_conv, float_to_float, float_to_str, title):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/_machar.py=MachAr=_do_init=123')
        max_iterN = 10000
    ...
    def __str__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/_machar.py=MachAr=__str__=340')
