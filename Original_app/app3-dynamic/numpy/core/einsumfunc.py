...
def _flop_count(idx_contraction, inner, num_terms, size_dictionary):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/einsumfunc.py=_flop_count=18')
...
def _compute_size_by_dict(indices, idx_dict):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/einsumfunc.py=_compute_size_by_dict=56')
    ret = 1
    for i in indices:
        ret *= idx_dict[i]
    return ret
...
def _find_contraction(positions, input_sets, output_set):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/einsumfunc.py=_find_contraction=85')
    idx_contract = set()
...
def _optimal_path(input_sets, output_set, idx_dict, memory_limit):
    ...
    [(0, 2), (0, 1)]
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/einsumfunc.py=_optimal_path=145')
...
def _parse_possible_contraction(positions, input_sets, output_set, idx_dict, memory_limit, path_cost, naive_cost):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/einsumfunc.py=_parse_possible_contraction=215')
...
def _update_other_results(results, best):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/einsumfunc.py=_update_other_results=273')
    best_con = best[1]
    (bx, by) = best_con
    mod_results = []
...
def _greedy_path(input_sets, output_set, idx_dict, memory_limit):
    ...
    [(0, 2), (0, 1)]
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/einsumfunc.py=_greedy_path=312')
    if len(input_sets) == 1:
        return [(0, )]
...
def _can_dot(inputs, result, idx_removed):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/einsumfunc.py=_can_dot=413')
...
def _parse_einsum_input(operands):
    ...
    ('za,xza', 'xz', [a, b]) # may vary
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/einsumfunc.py=_parse_einsum_input=523')
    if len(operands) == 0:
...
def _einsum_path_dispatcher(*operands, optimize=None, einsum_call=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/einsumfunc.py=_einsum_path_dispatcher=696')
    return operands
...
def einsum_path(*operands, optimize='greedy', einsum_call=False):
    ...
    *operands : list of array_like
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/einsumfunc.py=einsum_path=706')
    path_type = optimize
...
def _einsum_dispatcher(*operands, out=None, optimize=None, **kwargs):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/einsumfunc.py=_einsum_dispatcher=1001')
    yield from operands
    yield out
...
def einsum(*operands, out=None, optimize=False, **kwargs):
    ...
    * Chained array operations, in efficient calculation order, :py:func:`numpy.einsum_path`.
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/einsumfunc.py=einsum=1009')
