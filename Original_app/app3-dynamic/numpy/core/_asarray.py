...
def _require_dispatcher(a, dtype=None, requirements=None, *, like=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/_asarray.py=_require_dispatcher=27')
    return (like, )
...
def require(a, dtype=None, requirements=None, *, like=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/_asarray.py=require=31')
    if like is not None:
