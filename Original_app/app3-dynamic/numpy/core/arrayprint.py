...
def _make_options_dict(precision=None, threshold=None, edgeitems=None, linewidth=None, suppress=None, nanstr=None, infstr=None, sign=None, formatter=None, floatmode=None, legacy=None):
    ...
    *legacy* and sanity checks.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_make_options_dict=64')
...
def set_printoptions(precision=None, threshold=None, edgeitems=None, linewidth=None, suppress=None, nanstr=None, infstr=None, formatter=None, sign=None, floatmode=None, *, legacy=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=set_printoptions=116')
...
def get_printoptions():
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=get_printoptions=295')
...
def _get_legacy_print_mode():
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_get_legacy_print_mode=329')
...
def printoptions(*args, **kwargs):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=printoptions=334')
...
def _leading_trailing(a, edgeitems, index=()):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_leading_trailing=369')
    axis = len(index)
    if axis == a.ndim:
        return a[index]
...
def _object_format(o):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_object_format=389')
    if type(o) is list:
        fmt = 'list({!r})'
    else:
        fmt = '{!r}'
...
def repr_format(x):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=repr_format=397')
    return repr(x)

def str_format(x):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=str_format=400')
    return str(x)

def _get_formatdict(data, *, precision, floatmode, suppress, sign, legacy, formatter, **kwargs):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_get_formatdict=403')
    ...
    def indirect(x):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_get_formatdict=indirect=427')
        return lambda: x
...
def _get_format_function(data, **options):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_get_format_function=452')
    dtype_ = data.dtype
...
def _recursive_guard(fillvalue='...'):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_recursive_guard=493')
    
    def decorating_function(f):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_recursive_guard=decorating_function=503')
        repr_running = set()
        
        @functools.wraps(f)
        def wrapper(self, *args, **kwargs):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_recursive_guard=decorating_function=wrapper=506')
...
def _array2string(a, options, separator=' ', prefix=''):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_array2string=523')
    data = asarray(a)
    if a.shape == ():
        a = data
...
def _array2string_dispatcher(a, max_line_width=None, precision=None, suppress_small=None, separator=None, prefix=None, style=None, formatter=None, threshold=None, edgeitems=None, sign=None, floatmode=None, suffix=None, *, legacy=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_array2string_dispatcher=552')
    return (a, )
...
def array2string(a, max_line_width=None, precision=None, suppress_small=None, separator=' ', prefix='', style=np._NoValue, formatter=None, threshold=None, edgeitems=None, sign=None, floatmode=None, suffix='', *, legacy=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=array2string=561')
...
def _extendLine(s, line, word, line_width, next_line_prefix, legacy):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_extendLine=739')
...
def _extendLine_pretty(s, line, word, line_width, next_line_prefix, legacy):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_extendLine_pretty=753')
...
def _formatArray(a, format_function, line_width, next_line_prefix, separator, edge_items, summary_insert, legacy):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_formatArray=780')
    ...
    def recurser(index, hanging_indent, curr_width):
        ...
        not significant
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_formatArray=recurser=789')
        axis = len(index)
...
def _none_or_positive_arg(x, name):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_none_or_positive_arg=898')
    if x is None:
        return -1
    if x < 0:
...
class FloatingFormat:
    ...
    def __init__(self, data, precision, floatmode, suppress_small, sign=False, *, legacy=None):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=FloatingFormat=__init__=907')
    ...
    def fillFormat(self, data):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=FloatingFormat=fillFormat=934')
    ...
    def __call__(self, x):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=FloatingFormat=__call__=1018')
...
def format_float_scientific(x, precision=None, unique=True, trim='k', sign=False, pad_left=None, exp_digits=None, min_digits=None):
    ...
    '1.23e+0024'
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=format_float_scientific=1050')
...
def format_float_positional(x, precision=None, unique=True, fractional=True, trim='k', sign=False, pad_left=None, pad_right=None, min_digits=None):
    ...
    '0.3000488281'
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=format_float_positional=1130')
    precision = _none_or_positive_arg(precision, 'precision')
    pad_left = _none_or_positive_arg(pad_left, 'pad_left')
...
class IntegerFormat:
    ...
    def __init__(self, data):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=IntegerFormat=__init__=1223')
        if data.size > 0:
    ...
    def __call__(self, x):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=IntegerFormat=__call__=1231')
...
class BoolFormat:
    ...
    def __init__(self, data, **kwargs):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=BoolFormat=__init__=1236')
        self.truestr = (' True' if data.shape != () else 'True')
    
    def __call__(self, x):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=BoolFormat=__call__=1241')
...
class ComplexFloatingFormat:
    ...
    def __init__(self, x, precision, floatmode, suppress_small, sign=False, *, legacy=None):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=ComplexFloatingFormat=__init__=1247')
        if isinstance(sign, bool):
            sign = ('+' if sign else '-')
    ...
    def __call__(self, x):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=ComplexFloatingFormat=__call__=1267')
...
class _TimelikeFormat:
    ...
    def __init__(self, data):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_TimelikeFormat=__init__=1279')
    ...
    def _format_non_nat(self, x):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_TimelikeFormat=_format_non_nat=1293')
        raise NotImplementedError
    
    def __call__(self, x):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_TimelikeFormat=__call__=1297')
        if isnat(x):
            return self._nat
        else:
...
class DatetimeFormat(_TimelikeFormat):
    ...
    def __init__(self, x, unit=None, timezone=None, casting='same_kind', legacy=False):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=DatetimeFormat=__init__=1305')
        if unit is None:
            if x.dtype.kind == 'M':
    ...
    def __call__(self, x):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=DatetimeFormat=__call__=1324')
        if self.legacy <= 113:
            return self._format_non_nat(x)
        return super().__call__(x)
    
    def _format_non_nat(self, x):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=DatetimeFormat=_format_non_nat=1329')
...
class TimedeltaFormat(_TimelikeFormat):
    ...
    def _format_non_nat(self, x):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=TimedeltaFormat=_format_non_nat=1337')
...
class SubArrayFormat:
    ...
    def __init__(self, format_function):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=SubArrayFormat=__init__=1342')
        self.format_function = format_function
    
    def __call__(self, arr):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=SubArrayFormat=__call__=1345')
        if arr.ndim <= 1:
...
class StructuredVoidFormat:
    ...
    def __init__(self, format_functions):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=StructuredVoidFormat=__init__=1359')
    ...
    def from_data(cls, data, **options):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=StructuredVoidFormat=from_data=1362')
        format_functions = []
    ...
    def __call__(self, x):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=StructuredVoidFormat=__call__=1376')
...
def _void_scalar_repr(x):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_void_scalar_repr=1387')
...
def dtype_is_implied(dtype):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=dtype_is_implied=1399')
...
def dtype_short_repr(dtype):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=dtype_short_repr=1435')
...
def _array_repr_implementation(arr, max_line_width=None, precision=None, suppress_small=None, array2string=array2string):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_array_repr_implementation=1463')
...
def _array_repr_dispatcher(arr, max_line_width=None, precision=None, suppress_small=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_array_repr_dispatcher=1510')
    return (arr, )
...
def array_repr(arr, max_line_width=None, precision=None, suppress_small=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=array_repr=1515')
    return _array_repr_implementation(arr, max_line_width, precision, suppress_small)

@_recursive_guard()
def _guarded_repr_or_str(v):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_guarded_repr_or_str=1564')
...
def _array_str_implementation(a, max_line_width=None, precision=None, suppress_small=None, array2string=array2string):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_array_str_implementation=1571')
...
def _array_str_dispatcher(a, max_line_width=None, precision=None, suppress_small=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=_array_str_dispatcher=1591')
    return (a, )
...
def array_str(a, max_line_width=None, precision=None, suppress_small=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=array_str=1596')
...
def set_string_function(f, repr=True):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/core/arrayprint.py=set_string_function=1644')
    if f is None:
        if repr:
