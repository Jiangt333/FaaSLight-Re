...
class _SupportsArray(Protocol[_DType_co]):
    ...
    def __array__(self) -> ndarray[(Any, _DType_co)]:
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/_typing/_array_like.py=_SupportsArray=__array__=39')
        ...
...
class _SupportsArrayFunc(Protocol):
    ...
    def __array_function__(self, func: Callable[(..., Any)], types: Collection[type[Any]], args: tuple[(Any, ...)], kwargs: dict[(str, Any)]) -> object:
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/_typing/_array_like.py=_SupportsArrayFunc=__array_function__=45')
        ...
