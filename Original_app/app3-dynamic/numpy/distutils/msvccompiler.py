...
def _merge(old, new):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/msvccompiler.py=_merge=7')
    if new in old:
        return old
    if not old:
        return new
...
class MSVCCompiler(_MSVCCompiler):
    ...
    def __init__(self, verbose=0, dry_run=0, force=0):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/msvccompiler.py=MSVCCompiler=__init__=40')
        _MSVCCompiler.__init__(self, verbose, dry_run, force)
    
    def initialize(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/msvccompiler.py=MSVCCompiler=initialize=43')
...
def lib_opts_if_msvc(build_cmd):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/msvccompiler.py=lib_opts_if_msvc=61')
