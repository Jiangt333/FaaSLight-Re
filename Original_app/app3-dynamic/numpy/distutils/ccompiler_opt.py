...
class _Config:
    ...
    def conf_features_partial(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Config=conf_features_partial=329')
        if self.cc_noopt:
            return {}
    ...
    def __init__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Config=__init__=564')
        if self.conf_tmp_path is None:
            ...
            def rm_temp():
                print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Config=__init__=rm_temp=569')
                try:
                    shutil.rmtree(tmp)
                except OSError:
                    pass
...
class _Distutils:
    ...
    def __init__(self, ccompiler):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Distutils=__init__=596')
        self._ccompiler = ccompiler
    
    def dist_compile(self, sources, flags, ccompiler=None, **kwargs):
        """Wrap CCompiler.compile()"""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Distutils=dist_compile=599')
    ...
    def dist_test(self, source, flags, macros=[]):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Distutils=dist_test=609')
    ...
    def dist_info(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Distutils=dist_info=635')
    ...
    def dist_error(*args):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Distutils=dist_error=672')
        from distutils.errors import CompileError
    ...
    def dist_fatal(*args):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Distutils=dist_fatal=678')
    ...
    def dist_log(*args, stderr=False):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Distutils=dist_log=684')
    ...
    def dist_load_module(name, path):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Distutils=dist_load_module=694')
    ...
    def _dist_str(*args):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Distutils=_dist_str=704')
        
        def to_str(arg):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Distutils=_dist_str=to_str=707')
    ...
    def _dist_test_spawn_paths(self, cmd, display=None):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Distutils=_dist_test_spawn_paths=723')
    ...
    def _dist_test_spawn(cmd, display=None):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Distutils=_dist_test_spawn=746')
        try:
...
class _Cache:
    ...
    *factors :
    ...
    def __init__(self, cache_path=None, *factors):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Cache=__init__=799')
        self.cache_me = {}
    ...
    def __del__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Cache=__del__=844')
    ...
    def cache_flush(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Cache=cache_flush=850')
    ...
    def cache_hash(self, *factors):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Cache=cache_hash=878')
        chash = 0
        for f in factors:
            for char in str(f):
    ...
    def me(cb):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Cache=me=888')
        
        def cache_wrap_me(self, *args, **kwargs):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Cache=me=cache_wrap_me=894')
...
class _CCompiler:
    ...
    def __init__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_CCompiler=__init__=955')
    ...
    def cc_test_flags(self, flags):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_CCompiler=cc_test_flags=1071')
        assert isinstance(flags, list)
    ...
    def cc_test_cexpr(self, cexpr, flags=[]):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_CCompiler=cc_test_cexpr=1084')
    ...
    def cc_normalize_flags(self, flags):
        ...
        ['-march=core-avx2']
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_CCompiler=cc_normalize_flags=1103')
        assert isinstance(flags, list)
    ...
    def _cc_normalize_unix(self, flags):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_CCompiler=_cc_normalize_unix=1152')
        
        def ver_flags(f):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_CCompiler=_cc_normalize_unix=ver_flags=1153')
            tokens = f.split('+')
    ...
    def _cc_normalize_win(self, flags):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_CCompiler=_cc_normalize_win=1207')
...
class _Feature:
    ...
    def __init__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=__init__=1231')
    ...
    def feature_names(self, names=None, force_flags=None, macros=[]):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_names=1265')
    ...
    def feature_is_exist(self, name):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_is_exist=1300')
        assert name.isupper()
    ...
    def feature_sorted(self, names, reverse=False):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_sorted=1313')
        
        def sort_cb(k):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_sorted=sort_cb=1328')
            if isinstance(k, str):
    ...
    def feature_implies(self, names, keep_origins=False):
        ...
        {'SSE', 'SSE2'}
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_implies=1339')
        
        def get_implies(name, _caller=set()):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_implies=get_implies=1363')
            implies = set()
    ...
    def feature_implies_c(self, names):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_implies_c=1388')
        if isinstance(names, str):
            names = set((names, ))
        else:
            names = set(names)
    ...
    def feature_ahead(self, names):
        ...
        ["AVX2", "FMA3"]
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_ahead=1396')
    ...
    def feature_untied(self, names):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_untied=1434')
        assert (not isinstance(names, str) and hasattr(names, '__iter__'))
        final = []
        for n in names:
    ...
    def feature_get_til(self, names, keyisfalse):
        ...
        features.
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_get_til=1475')
        
        def til(tnames):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_get_til=til=1482')
    ...
    def feature_detect(self, names):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_detect=1502')
    ...
    def feature_flags(self, names):
        ...
        to highest interest.
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_flags=1514')
    ...
    def feature_test(self, name, force_flags=None, macros=[]):
        ...
        macros : list of tuples, optional
            A list of C macro definitions.
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_test=1530')
    ...
    def feature_is_supported(self, name, force_flags=None, macros=[]):
        ...
        macros : list of tuples, optional
            A list of C macro definitions.
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_is_supported=1570')
        assert name.isupper()
        assert (force_flags is None or isinstance(force_flags, list))
    ...
    def feature_can_autovec(self, name):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_can_autovec=1599')
    ...
    def feature_extra_checks(self, name):
        ...
        names : str
            CPU feature name in uppercase.
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_extra_checks=1614')
        assert isinstance(name, str)
        d = self.feature_supported[name]
    ...
    def feature_c_preprocessor(self, feature_name, tabs=0):
        ...
        #include <pmmintrin.h>
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Feature=feature_c_preprocessor=1653')
...
class _Parse:
    ...
    def __init__(self, cpu_baseline, cpu_dispatch):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Parse=__init__=1749')
    ...
    def parse_targets(self, source):
        ...
        - list, list of extra compiler flags
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Parse=parse_targets=1831')
    ...
    def _parse_arg_features(self, arg_name, req_features):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Parse=_parse_arg_features=1886')
    ...
    def _parse_target_tokens(self, tokens):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Parse=_parse_target_tokens=1943')
    ...
    def _parse_token_policy(self, token):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Parse=_parse_token_policy=2059')
    ...
    def _parse_token_group(self, token, has_baseline, final_targets, extra_flags):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Parse=_parse_token_group=2071')
        if (len(token) <= 1 or token[-1:] == token[0]):
    ...
    def _parse_multi_target(self, targets):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Parse=_parse_multi_target=2093')
        if not targets:
    ...
    def _parse_policy_not_keepbase(self, has_baseline, final_targets, extra_flags):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Parse=_parse_policy_not_keepbase=2118')
        skipped = []
    ...
    def _parse_policy_keepsort(self, has_baseline, final_targets, extra_flags):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Parse=_parse_policy_keepsort=2140')
    ...
    def _parse_policy_not_keepsort(self, has_baseline, final_targets, extra_flags):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Parse=_parse_policy_not_keepsort=2149')
    ...
    def _parse_policy_maxopt(self, has_baseline, final_targets, extra_flags):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Parse=_parse_policy_maxopt=2154')
    ...
    def _parse_policy_werror(self, has_baseline, final_targets, extra_flags):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Parse=_parse_policy_werror=2171')
    ...
    def _parse_policy_autovec(self, has_baseline, final_targets, extra_flags):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=_Parse=_parse_policy_autovec=2184')
        skipped = []
        for tar in final_targets[:]:
            if isinstance(tar, str):
...
class CCompilerOpt(_Config, _Distutils, _Cache, _CCompiler, _Feature, _Parse):
    ...
    def __init__(self, ccompiler, cpu_baseline='min', cpu_dispatch='max', cache_path=None):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=CCompilerOpt=__init__=2210')
    ...
    def is_cached(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=CCompilerOpt=is_cached=2236')
    ...
    def cpu_baseline_flags(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=CCompilerOpt=cpu_baseline_flags=2242')
    ...
    def cpu_baseline_names(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=CCompilerOpt=cpu_baseline_names=2248')
    ...
    def cpu_dispatch_names(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=CCompilerOpt=cpu_dispatch_names=2254')
    ...
    def try_dispatch(self, sources, src_dir=None, ccompiler=None, **kwargs):
        ...
        **kwargs : any
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=CCompilerOpt=try_dispatch=2260')
        to_compile = {}
    ...
    def generate_dispatch_header(self, header_path):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=CCompilerOpt=generate_dispatch_header=2347')
    ...
    def report(self, full=False):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=CCompilerOpt=report=2430')
        report = []
        platform_rows = []
        baseline_rows = []
        dispatch_rows = []
    ...
    def _wrap_target(self, output_dir, dispatch_src, target, nochange=False):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=CCompilerOpt=_wrap_target=2539')
    ...
    def _generate_config(self, output_dir, dispatch_src, targets, has_baseline=False):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=CCompilerOpt=_generate_config=2577')
...
def new_ccompiler_opt(compiler, dispatch_hpath, **kwargs):
    ...
    **kwargs: passed as-is to `CCompilerOpt(...)`
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler_opt.py=new_ccompiler_opt=2639')
