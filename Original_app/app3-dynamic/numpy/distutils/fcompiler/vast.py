...
class VastFCompiler(GnuFCompiler):
    ...
    def find_executables(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/vast.py=VastFCompiler=find_executables=30')
        pass
    
    def get_version_cmd(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/vast.py=VastFCompiler=get_version_cmd=33')
    ...
    def get_flags_arch(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/vast.py=VastFCompiler=get_flags_arch=39')
