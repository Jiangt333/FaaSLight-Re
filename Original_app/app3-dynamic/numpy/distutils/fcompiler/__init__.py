...
def flaglist(s):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=flaglist=43')
    if is_string(s):
...
def str2bool(s):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=str2bool=49')
    if is_string(s):
        return strtobool(s)
    return bool(s)

def is_sequence_of_strings(seq):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=is_sequence_of_strings=54')
...
class FCompiler(CCompiler):
    ...
    def __init__(self, *args, **kw):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=__init__=214')
    ...
    def __copy__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=__copy__=228')
    ...
    def copy(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=copy=237')
        return self.__copy__()
    
    def _command_property(key):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=_command_property=243')
        
        def fget(self):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=_command_property=fget=244')
    ...
    def set_executable(self, key, value):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=set_executable=258')
        self.set_command(key, value)
    
    def set_commands(self, **kw):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=set_commands=261')
        for (k, v) in kw.items():
            self.set_command(k, v)
    
    def set_command(self, key, value):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=set_command=265')
    ...
    def find_executables(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=find_executables=280')
        assert self._is_customised
        exe_cache = self._exe_cache
        
        def cached_find_executable(exe):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=find_executables=cached_find_executable=296')
            if exe in exe_cache:
        ...
        def verify_command_form(name, value):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=find_executables=verify_command_form=302')
        ...
        def set_exe(exe_key, f77=None, f90=None):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=find_executables=set_exe=307')
    ...
    def update_executables(self):
        ...
        compiler.
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=update_executables=359')
        pass
    
    def get_flags(self):
        """List of flags common to all compiler types."""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=get_flags=370')
        return [] + self.pic_flags
    
    def _get_command_flags(self, key):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=_get_command_flags=374')
    ...
    def get_flags_f77(self):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=get_flags_f77=380')
        return self._get_command_flags('compiler_f77')
    
    def get_flags_f90(self):
        """List of Fortran 90 specific flags."""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=get_flags_f90=383')
        return self._get_command_flags('compiler_f90')
    
    def get_flags_free(self):
        """List of Fortran 90 free format specific flags."""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=get_flags_free=386')
        return []
    
    def get_flags_fix(self):
        """List of Fortran 90 fixed format specific flags."""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=get_flags_fix=389')
        return self._get_command_flags('compiler_fix')
    
    def get_flags_linker_so(self):
        """List of linker flags to build a shared library."""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=get_flags_linker_so=392')
        return self._get_command_flags('linker_so')
    
    def get_flags_linker_exe(self):
        """List of linker flags to build an executable."""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=get_flags_linker_exe=395')
        return self._get_command_flags('linker_exe')
    
    def get_flags_ar(self):
        """List of archiver flags. """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=get_flags_ar=398')
        return self._get_command_flags('archiver')
    
    def get_flags_opt(self):
        """List of architecture independent compiler flags."""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=get_flags_opt=401')
        return []
    
    def get_flags_arch(self):
        """List of architecture dependent compiler flags."""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=get_flags_arch=404')
        return []
    
    def get_flags_debug(self):
        """List of compiler flags to compile with debugging information."""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=get_flags_debug=407')
        return []
    ...
    def get_libraries(self):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=get_libraries=415')
        return self.libraries[:]
    
    def get_library_dirs(self):
        """List of compiler library directories."""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=get_library_dirs=418')
        return self.library_dirs[:]
    
    def get_version(self, force=False, ok_status=[0]):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=get_version=422')
        assert self._is_customised
    ...
    def customize(self, dist=None):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=customize=434')
        ...
        def get_flags(tag, flags):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=customize=get_flags=494')
    ...
    def dump_properties(self):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=dump_properties=551')
        props = []
    ...
    def _compile(self, obj, src, ext, cc_args, extra_postargs, pp_opts):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=_compile=571')
        src_flags = {}
    ...
    def module_options(self, module_dirs, module_build_dir):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=module_options=621')
        options = []
    ...
    def library_option(self, lib):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=library_option=639')
        return '-l' + lib
    
    def library_dir_option(self, dir):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=library_dir_option=641')
        return '-L' + dir
    
    def link(self, target_desc, objects, output_filename, output_dir=None, libraries=None, library_dirs=None, runtime_library_dirs=None, export_symbols=None, debug=0, extra_preargs=None, extra_postargs=None, build_temp=None, target_lang=None):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=link=644')
    ...
    def _environment_hook(self, name, hook_name):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=_environment_hook=691')
    ...
    def can_ccompiler_link(self, ccompiler):
        ...
        this compiler.
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=can_ccompiler_link=713')
        return True
    ...
    def wrap_unlinkable_objects(self, objects, output_dir, extra_dll_dir):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=FCompiler=wrap_unlinkable_objects=720')
...
def load_all_fcompiler_classes():
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=load_all_fcompiler_classes=769')
...
def _find_existing_fcompiler(compiler_types, osname=None, platform=None, requiref90=False, c_compiler=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=_find_existing_fcompiler=797')
...
def available_fcompilers_for_platform(osname=None, platform=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=available_fcompilers_for_platform=834')
    if osname is None:
        osname = os.name
    if platform is None:
...
def get_default_fcompiler(osname=None, platform=None, requiref90=False, c_compiler=None):
    ...
    platform."""
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=get_default_fcompiler=849')
...
def new_fcompiler(plat=None, compiler=None, verbose=0, dry_run=0, force=0, requiref90=False, c_compiler=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=new_fcompiler=867')
...
def show_fcompilers(dist=None):
    ...
    option to "config_fc").
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=show_fcompilers=906')
    if dist is None:
...
def dummy_fortran_file():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=dummy_fortran_file=966')
...
def is_free_format(file):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=is_free_format=979')
    result = 0
...
def has_f90_header(src):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=has_f90_header=1002')
...
def get_f77flags(src):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/__init__.py=get_f77flags=1008')
    flags = {}
    with open(src, encoding='latin1') as f:
        i = 0
        for line in f:
