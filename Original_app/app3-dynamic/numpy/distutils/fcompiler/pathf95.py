...
class PathScaleFCompiler(FCompiler):
    ...
    def get_flags_opt(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/pathf95.py=PathScaleFCompiler=get_flags_opt=24')
        return ['-O3']
    
    def get_flags_debug(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/pathf95.py=PathScaleFCompiler=get_flags_debug=26')
        return ['-g']
