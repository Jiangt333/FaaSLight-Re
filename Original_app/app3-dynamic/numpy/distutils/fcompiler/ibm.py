...
class IBMFCompiler(FCompiler):
    ...
    def get_version(self, *args, **kwds):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/ibm.py=IBMFCompiler=get_version=29')
    ...
    def get_flags(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/ibm.py=IBMFCompiler=get_flags=59')
        return ['-qextname']
    
    def get_flags_debug(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/ibm.py=IBMFCompiler=get_flags_debug=62')
        return ['-g']
    
    def get_flags_linker_so(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/ibm.py=IBMFCompiler=get_flags_linker_so=65')
        opt = []
    ...
    def get_flags_opt(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/ibm.py=IBMFCompiler=get_flags_opt=91')
        return ['-O3']
