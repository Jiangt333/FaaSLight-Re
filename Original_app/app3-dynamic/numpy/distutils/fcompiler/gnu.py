...
def is_win64():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=is_win64=22')
...
class GnuFCompiler(FCompiler):
    ...
    def gnu_version_match(self, version_string):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=GnuFCompiler=gnu_version_match=31')
    ...
    def version_match(self, version_string):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=GnuFCompiler=version_match=76')
    ...
    def get_flags_linker_so(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=GnuFCompiler=get_flags_linker_so=109')
    ...
    def get_libgcc_dir(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=GnuFCompiler=get_libgcc_dir=144')
        try:
    ...
    def get_libgfortran_dir(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=GnuFCompiler=get_libgfortran_dir=155')
    ...
    def get_library_dirs(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=GnuFCompiler=get_library_dirs=176')
        opt = []
        if sys.platform[:5] != 'linux':
    ...
    def get_libraries(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=GnuFCompiler=get_libraries=198')
        opt = []
        d = self.get_libgcc_dir()
        if d is not None:
            g2c = self.g2c + '-pic'
    ...
    def get_flags_debug(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=GnuFCompiler=get_flags_debug=219')
        return ['-g']
    
    def get_flags_opt(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=GnuFCompiler=get_flags_opt=222')
        v = self.get_version()
        if (v and v <= '3.3.3'):
            opt = ['-O2']
        else:
    ...
    def _c_arch_flags(self):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=GnuFCompiler=_c_arch_flags=233')
        import sysconfig
        try:
    ...
    def get_flags_arch(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=GnuFCompiler=get_flags_arch=246')
        return []
    
    def runtime_library_dir_option(self, dir):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=GnuFCompiler=runtime_library_dir_option=249')
...
class Gnu95FCompiler(GnuFCompiler):
    ...
    def version_match(self, version_string):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=Gnu95FCompiler=version_match=271')
        v = self.gnu_version_match(version_string)
    ...
    def _universal_flags(self, cmd):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=Gnu95FCompiler=_universal_flags=316')
    ...
    def get_flags(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=Gnu95FCompiler=get_flags=332')
    ...
    def get_flags_linker_so(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=Gnu95FCompiler=get_flags_linker_so=339')
    ...
    def get_library_dirs(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=Gnu95FCompiler=get_library_dirs=346')
    ...
    def get_libraries(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=Gnu95FCompiler=get_libraries=365')
    ...
    def get_target(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=Gnu95FCompiler=get_target=383')
        try:
    ...
    def _hash_files(self, filenames):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=Gnu95FCompiler=_hash_files=401')
        h = hashlib.sha1()
        for fn in filenames:
    ...
    def _link_wrapper_lib(self, objects, output_dir, extra_dll_dir, chained_dlls, is_archive):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=Gnu95FCompiler=_link_wrapper_lib=414')
        c_compiler = self.c_compiler
    ...
    def can_ccompiler_link(self, compiler):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=Gnu95FCompiler=can_ccompiler_link=476')
    ...
    def wrap_unlinkable_objects(self, objects, output_dir, extra_dll_dir):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=Gnu95FCompiler=wrap_unlinkable_objects=480')
...
def _can_target(cmd, arch):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/fcompiler/gnu.py=_can_target=526')
    newcmd = cmd[:]
