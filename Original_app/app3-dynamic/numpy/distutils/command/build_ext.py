...
class build_ext(old_build_ext):
    ...
    def initialize_options(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_ext.py=build_ext=initialize_options=52')
    ...
    def finalize_options(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_ext.py=build_ext=finalize_options=62')
        if self.parallel:
            try:
    ...
    def run(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_ext.py=build_ext=run=96')
        ...
        if not self.disable_optimization:
            ...
            def report(copt):
                print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_ext.py=build_ext=run=report=168')
    ...
    def swig_sources(self, sources, extensions=None):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_ext.py=build_ext=swig_sources=355')
        return sources
    
    def build_extension(self, ext):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_ext.py=build_ext=build_extension=359')
        sources = ext.sources
    ...
    def _add_dummy_mingwex_sym(self, c_sources):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_ext.py=build_ext=_add_dummy_mingwex_sym=618')
    ...
    def _process_unlinkable_fobjects(self, objects, libraries, fcompiler, library_dirs, unlinkable_fobjects):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_ext.py=build_ext=_process_unlinkable_fobjects=627')
    ...
    def _libs_with_msvc_and_fortran(self, fcompiler, c_libraries, c_library_dirs):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_ext.py=build_ext=_libs_with_msvc_and_fortran=662')
    ...
    def get_source_files(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_ext.py=build_ext=get_source_files=723')
    ...
    def get_outputs(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_ext.py=build_ext=get_outputs=730')
        self.check_extensions_list(self.extensions)
        outputs = []
        for ext in self.extensions:
            if not ext.sources:
