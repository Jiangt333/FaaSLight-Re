...
def subst_vars(target, source, d):
    ...
    target."""
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=subst_vars=25')
...
class build_src(build_ext.build_ext):
    ...
    def initialize_options(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=initialize_options=63')
    ...
    def finalize_options(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=finalize_options=82')
    ...
    def run(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=run=140')
        log.info('build_src')
    ...
    def build_sources(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=build_sources=146')
        if self.inplace:
    ...
    def build_data_files_sources(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=build_data_files_sources=166')
    ...
    def _build_npy_pkg_config(self, info, gd):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=_build_npy_pkg_config=202')
    ...
    def build_npy_pkg_config(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=build_npy_pkg_config=224')
    ...
    def build_py_modules_sources(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=build_py_modules_sources=254')
    ...
    def build_library_sources(self, lib_name, build_info):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=build_library_sources=280')
    ...
    def build_extension_sources(self, ext):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=build_extension_sources=304')
    ...
    def generate_sources(self, sources, extension):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=generate_sources=344')
        new_sources = []
        func_sources = []
    ...
    def filter_py_files(self, sources):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=filter_py_files=390')
        return self.filter_files(sources, ['.py'])
    
    def filter_h_files(self, sources):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=filter_h_files=393')
        return self.filter_files(sources, ['.h', '.hpp', '.inc'])
    
    def filter_files(self, sources, exts=[]):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=filter_files=396')
        new_sources = []
        files = []
        for source in sources:
    ...
    def template_sources(self, sources, extension):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=template_sources=407')
        new_sources = []
        if is_sequence(extension):
    ...
    def pyrex_sources(self, sources, extension):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=pyrex_sources=443')
        new_sources = []
    ...
    def generate_a_pyrex_source(self, base, ext_name, source, extension):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=generate_a_pyrex_source=458')
        return []
    
    def f2py_sources(self, sources, extension):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=f2py_sources=466')
        new_sources = []
        f2py_sources = []
        f_sources = []
        f2py_targets = {}
    ...
    def swig_sources(self, sources, extension):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=build_src=swig_sources=604')
        new_sources = []
        swig_sources = []
        swig_targets = {}
        target_dirs = []
...
def get_swig_target(source):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=get_swig_target=727')
...
def get_swig_modulename(source):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=get_swig_modulename=737')
    with open(source, 'r') as f:
        name = None
        for line in f:
...
def _find_swig_target(target_dir, name):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=_find_swig_target=747')
    for ext in ['.cpp', '.c']:
...
def get_f2py_modulename(source):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_src.py=get_f2py_modulename=761')
    name = None
