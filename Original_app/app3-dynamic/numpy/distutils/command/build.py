...
class build(old_build):
    ...
    def initialize_options(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build.py=build=initialize_options=34')
    ...
    def finalize_options(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build.py=build=finalize_options=53')
    ...
    def run(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build.py=build=run=61')
        old_build.run(self)
