...
def show_fortran_compilers(_cache=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/config_compiler.py=show_fortran_compilers=6')
    if _cache:
        return
    elif _cache is None:
        _cache = []
...
class config_fc(Command):
    ...
    def initialize_options(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/config_compiler.py=config_fc=initialize_options=47')
        self.fcompiler = None
        self.f77exec = None
        self.f90exec = None
        self.f77flags = None
    ...
    def finalize_options(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/config_compiler.py=config_fc=finalize_options=59')
    ...
    def run(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/config_compiler.py=config_fc=run=82')
        return
...
class config_cc(Command):
    ...
    def initialize_options(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/config_compiler.py=config_cc=initialize_options=97')
        self.compiler = None
    
    def finalize_options(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/config_compiler.py=config_cc=finalize_options=100')
    ...
    def run(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/config_compiler.py=config_cc=run=124')
        return
