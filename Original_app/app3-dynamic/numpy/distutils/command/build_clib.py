...
class build_clib(old_build_clib):
    ...
    def initialize_options(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_clib.py=build_clib=initialize_options=49')
    ...
    def finalize_options(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_clib.py=build_clib=finalize_options=60')
        if self.parallel:
            try:
    ...
    def have_f_sources(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_clib.py=build_clib=have_f_sources=75')
    ...
    def have_cxx_sources(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_clib.py=build_clib=have_cxx_sources=81')
        for (lib_name, build_info) in self.libraries:
    ...
    def run(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_clib.py=build_clib=run=87')
        ...
        if not self.disable_optimization:
            ...
            def report(copt):
                print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_clib.py=build_clib=run=report=140')
    ...
    def get_source_files(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_clib.py=build_clib=get_source_files=177')
    ...
    def build_libraries(self, libraries):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_clib.py=build_clib=build_libraries=184')
    ...
    def assemble_flags(self, in_flags):
        ...
        out_flags : list
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_clib.py=build_clib=assemble_flags=188')
        if in_flags is None:
            return []
        out_flags = []
    ...
    def build_a_library(self, build_info, lib_name, libraries):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/command/build_clib.py=build_clib=build_a_library=212')
