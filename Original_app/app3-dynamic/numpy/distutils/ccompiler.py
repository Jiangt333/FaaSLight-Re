...
def _needs_build(obj, cc_args, extra_postargs, pp_opts):
    ...
    bool
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=_needs_build=37')
    dep_file = obj + '.d'
...
def replace_method(klass, method_name, func):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=replace_method=87')
...
def CCompiler_find_executables(self):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=CCompiler_find_executables=98')
    pass
...
def CCompiler_spawn(self, cmd, display=None, env=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=CCompiler_spawn=112')
...
def CCompiler_object_filenames(self, source_filenames, strip_dir=0, output_dir=''):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=CCompiler_object_filenames=185')
...
def CCompiler_compile(self, sources, output_dir=None, macros=None, include_dirs=None, debug=0, extra_preargs=None, extra_postargs=None, depends=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=CCompiler_compile=232')
    ...
    def single_compile(args):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=CCompiler_compile=single_compile=305')
        (obj, (src, ext)) = args
...
def CCompiler_customize_cmd(self, cmd, ignore=()):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=CCompiler_customize_cmd=372')
    ...
    def allow(attr):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=CCompiler_customize_cmd=allow=400')
...
def _compiler_to_string(compiler):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=_compiler_to_string=422')
    props = []
    mx = 0
...
def CCompiler_show_customization(self):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=CCompiler_show_customization=440')
    try:
        self.get_version()
    except Exception:
        pass
...
def CCompiler_customize(self, dist, need_cxx=0):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=CCompiler_customize=469')
...
def simple_version_match(pat='[-.\\d]+', ignore='', start=''):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=simple_version_match=552')
    
    def matcher(self, version_string):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=simple_version_match=matcher=578')
...
def CCompiler_get_version(self, force=False, ok_status=[0]):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=CCompiler_get_version=599')
    ...
    try:
        ...
        def matcher(version_string):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=CCompiler_get_version=matcher=635')
...
def CCompiler_cxx_compiler(self):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=CCompiler_cxx_compiler=668')
...
def new_compiler(plat=None, compiler=None, verbose=None, dry_run=0, force=0):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=new_compiler=741')
    if verbose is None:
...
def gen_lib_options(compiler, library_dirs, runtime_library_dirs, libraries):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/ccompiler.py=gen_lib_options=788')
