...
def _dict_append(d, **kws):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/core.py=_dict_append=55')
...
def _command_line_ok(_cache=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/core.py=_command_line_ok=72')
    if _cache:
        return _cache[0]
    elif _cache is None:
        _cache = []
...
def get_distribution(always=False):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/core.py=get_distribution=92')
...
def setup(**attr):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/core.py=setup=107')
...
def _check_append_library(libraries, item):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/core.py=_check_append_library=171')
...
def _check_append_ext_library(libraries, lib_name, build_info):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/core.py=_check_append_ext_library=200')
    for item in libraries:
        if is_sequence(item):
            if item[0] == lib_name:
