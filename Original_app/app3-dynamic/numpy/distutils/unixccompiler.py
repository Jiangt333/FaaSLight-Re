...
def UnixCCompiler__compile(self, obj, src, ext, cc_args, extra_postargs, pp_opts):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/unixccompiler.py=UnixCCompiler__compile=17')
...
def UnixCCompiler_create_static_lib(self, objects, output_libname, output_dir=None, debug=0, target_lang=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/unixccompiler.py=UnixCCompiler_create_static_lib=73')
