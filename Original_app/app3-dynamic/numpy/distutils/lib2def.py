...
libfile, deffile = parse_cmd()"""
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/lib2def.py=parse_cmd=38')
    if len(sys.argv) == 3:
...
nm_output = getnm(nm_cmd = 'nm -Cs py_lib')"""
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/lib2def.py=getnm=62')
...
dlist, flist = parse_nm(nm_output)"""
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/lib2def.py=parse_nm=74')
...
output_def(dlist, flist, header, file = sys.stdout)"""
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/lib2def.py=output_def=96')
