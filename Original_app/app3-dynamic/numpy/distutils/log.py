...
def _fix_args(args, flag=1):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/log.py=_fix_args=11')
    if is_string(args):
        return args.replace('%', '%%')
...
class Log(old_Log):
    ...
    def _log(self, level, msg, args):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/log.py=Log=_log=20')
    ...
    def good(self, msg, *args):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/log.py=Log=good=32')
...
def set_threshold(level, force=False):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/log.py=set_threshold=50')
...
def get_threshold():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/log.py=get_threshold=64')
    return _global_log.threshold

def set_verbosity(v, force=False):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/log.py=set_verbosity=67')
    prev_level = _global_log.threshold
    if v < 0:
...
def error(msg, *a, **kw):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/log.py=error=98')
    _error(f'ERROR: {msg}', *a, **kw)

def warn(msg, *a, **kw):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/log.py=warn=102')
    _warn(f'WARN: {msg}', *a, **kw)

def info(msg, *a, **kw):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/log.py=info=106')
    _info(f'INFO: {msg}', *a, **kw)

def debug(msg, *a, **kw):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/log.py=debug=110')
