...
def get_msvcr_replacement():
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=get_msvcr_replacement=35')
...
class Mingw32CCompiler(distutils.cygwinccompiler.CygwinCCompiler):
    ...
    def __init__(self, verbose=0, dry_run=0, force=0):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=Mingw32CCompiler=__init__=53')
    ...
    def link(self, target_desc, objects, output_filename, output_dir, libraries, library_dirs, runtime_library_dirs, export_symbols=None, debug=0, extra_preargs=None, extra_postargs=None, build_temp=None, target_lang=None):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=Mingw32CCompiler=link=109')
    ...
    def object_filenames(self, source_filenames, strip_dir=0, output_dir=''):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=Mingw32CCompiler=object_filenames=148')
...
def find_python_dll():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=find_python_dll=183')
    stems = [sys.prefix]
...
def dump_table(dll):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=dump_table=221')
...
def generate_def(dll, dfile):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=generate_def=225')
    dump = dump_table(dll)
...
def find_dll(dll_name):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=find_dll=257')
    arch = {'AMD64': 'amd64', 'Intel': 'x86'}[get_build_architecture()]
    
    def _find_dll_in_winsxs(dll_name):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=find_dll=_find_dll_in_winsxs=262')
    ...
    def _find_dll_in_path(dll_name):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=find_dll=_find_dll_in_path=273')
...
def build_msvcr_library(debug=False):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=build_msvcr_library=283')
    if os.name != 'nt':
        return False
...
def build_import_library():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=build_import_library=342')
    if os.name != 'nt':
        return
...
def _check_for_import_lib():
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=_check_for_import_lib=354')
    (major_version, minor_version) = tuple(sys.version_info[:2])
...
def _build_import_library_amd64():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=_build_import_library_amd64=390')
...
def _build_import_library_x86():
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=_build_import_library_x86=410')
    (out_exists, out_file) = _check_for_import_lib()
    if out_exists:
        log.debug('Skip building import library: "%s" exists', out_file)
        return
...
def msvc_manifest_xml(maj, min):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=msvc_manifest_xml=499')
    try:
...
def manifest_rc(name, type='dll'):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=manifest_rc=531')
    if type == 'dll':
        rctype = 2
    elif type == 'exe':
        rctype = 1
...
def check_embedded_msvcr_match_linked(msver):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=check_embedded_msvcr_match_linked=555')
...
def configtest_name(config):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=configtest_name=567')
    base = os.path.basename(config._gen_temp_sourcefile('yo', [], 'c'))
    return os.path.splitext(base)[0]

def manifest_name(config):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=manifest_name=571')
    root = configtest_name(config)
    exext = config.compiler.exe_extension
    return root + exext + '.manifest'

def rc_name(config):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=rc_name=577')
    root = configtest_name(config)
    return root + '.rc'

def generate_manifest(config):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/mingw32ccompiler.py=generate_manifest=582')
