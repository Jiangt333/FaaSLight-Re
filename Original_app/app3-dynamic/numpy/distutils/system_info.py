...
def customized_ccompiler():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=customized_ccompiler=213')
...
def _c_string_literal(s):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=_c_string_literal=220')
    s = s.replace('\\', '\\\\')
    s = s.replace('"', '\\"')
    s = s.replace('\n', '\\n')
    return '"{}"'.format(s)
...
def libpaths(paths, bits):
    ...
    '/usr/lib64', '/usr/lib']
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=libpaths=231')
...
if sys.platform == 'win32':
    ...
    def add_system_root(library_root):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=add_system_root=289')
...
def get_standard_file(fname):
    ...
    3) Local directory
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=get_standard_file=378')
    filenames = []
    try:
        f = __file__
    except NameError:
...
def _parse_env_order(base_order, env):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=_parse_env_order=413')
...
def get_info(name, notfound_action=0):
    ...
    notfound_action:
      ...
      2 - raise error
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=get_info=497')
...
class system_info:
    ...
    def __init__(self, default_lib_dirs=default_lib_dirs, default_include_dirs=default_include_dirs):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=__init__=715')
        self.__class__.info = {}
        self.local_prefixes = []
    ...
    def parse_config_files(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=parse_config_files=739')
    ...
    def calc_libraries_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=calc_libraries_info=745')
    ...
    def set_info(self, **info):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=set_info=776')
        if info:
    ...
    def get_option_single(self, *options):
        ...
        *options : list of str
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=get_option_single=785')
    ...
    def has_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=has_info=817')
    ...
    def calc_extra_info(self):
        ...
        respect to these flags:
          ...
          extra_link_args
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=calc_extra_info=820')
        info = {}
    ...
    def get_info(self, notfound_action=0):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=get_info=836')
        flag = 0
    ...
    def get_paths(self, section, key):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=get_paths=872')
    ...
    def get_lib_dirs(self, key='library_dirs'):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=get_lib_dirs=927')
        return self.get_paths(self.section, key)
    
    def get_runtime_lib_dirs(self, key='runtime_library_dirs'):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=get_runtime_lib_dirs=930')
    ...
    def get_include_dirs(self, key='include_dirs'):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=get_include_dirs=936')
        return self.get_paths(self.section, key)
    
    def get_src_dirs(self, key='src_dirs'):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=get_src_dirs=939')
        return self.get_paths(self.section, key)
    
    def get_libs(self, key, default):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=get_libs=942')
        try:
    ...
    def get_libraries(self, key='libraries'):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=get_libraries=953')
    ...
    def library_extensions(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=library_extensions=959')
    ...
    def check_libs(self, lib_dirs, libs, opt_libs=[]):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=check_libs=977')
    ...
    def check_libs2(self, lib_dirs, libs, opt_libs=[]):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=check_libs2=995')
        exts = self.library_extensions()
    ...
    def _find_lib(self, lib_dir, lib, exts):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=_find_lib=1009')
    ...
    def _find_libs(self, lib_dirs, libs, exts):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=_find_libs=1034')
    ...
    def _check_libs(self, lib_dirs, libs, opt_libs, exts):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=_check_libs=1047')
    ...
    def combine_paths(self, *args):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=system_info=combine_paths=1068')
...
class fft_opt_info(system_info):
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=fft_opt_info=calc_info=1077')
        info = {}
...
class fftw_info(system_info):
    ...
    def calc_ver_info(self, ver_param):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=fftw_info=calc_ver_info=1103')
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=fftw_info=calc_info=1130')
...
class djbfft_info(system_info):
    ...
    def get_paths(self, section, key):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=djbfft_info=get_paths=1220')
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=djbfft_info=calc_info=1227')
        lib_dirs = self.get_lib_dirs()
        incl_dirs = self.get_include_dirs()
        info = None
        for d in lib_dirs:
...
class mkl_info(system_info):
    ...
    def get_mkl_rootdir(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=mkl_info=get_mkl_rootdir=1256')
    ...
    def __init__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=mkl_info=__init__=1284')
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=mkl_info=calc_info=1301')
        lib_dirs = self.get_lib_dirs()
        incl_dirs = self.get_include_dirs()
...
class armpl_info(system_info):
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=armpl_info=calc_info=1333')
        lib_dirs = self.get_lib_dirs()
        incl_dirs = self.get_include_dirs()
...
class atlas_info(system_info):
    ...
    def get_paths(self, section, key):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=atlas_info=get_paths=1366')
        pre_dirs = system_info.get_paths(self, section, key)
        dirs = []
        for d in pre_dirs:
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=atlas_info=calc_info=1374')
        lib_dirs = self.get_lib_dirs()
        info = {}
...
class atlas_blas_info(atlas_info):
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=atlas_blas_info=calc_info=1465')
        lib_dirs = self.get_lib_dirs()
        info = {}
        opt = self.get_option_single('atlas_libs', 'libraries')
        atlas_libs = self.get_libs(opt, self._lib_names + self._lib_atlas)
...
class atlas_3_10_blas_info(atlas_3_10_info):
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=atlas_3_10_blas_info=calc_info=1518')
        lib_dirs = self.get_lib_dirs()
        info = {}
...
class lapack_info(system_info):
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_info=calc_info=1570')
        lib_dirs = self.get_lib_dirs()
...
class lapack_src_info(system_info):
    ...
    def get_paths(self, section, key):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_src_info=get_paths=1590')
        pre_dirs = system_info.get_paths(self, section, key)
        dirs = []
        for d in pre_dirs:
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_src_info=calc_info=1597')
...
def get_atlas_version(**config):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=get_atlas_version=1713')
...
class lapack_opt_info(system_info):
    ...
    def _calc_info_armpl(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_opt_info=_calc_info_armpl=1794')
    ...
    def _calc_info_mkl(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_opt_info=_calc_info_mkl=1801')
    ...
    def _calc_info_openblas(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_opt_info=_calc_info_openblas=1808')
    ...
    def _calc_info_flame(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_opt_info=_calc_info_flame=1819')
        info = get_info('flame')
        if info:
            self.set_info(**info)
            return True
    ...
    def _calc_info_atlas(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_opt_info=_calc_info_atlas=1826')
    ...
    def _calc_info_accelerate(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_opt_info=_calc_info_accelerate=1851')
    ...
    def _get_info_blas(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_opt_info=_get_info_blas=1858')
    ...
    def _get_info_lapack(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_opt_info=_get_info_lapack=1870')
    ...
    def _calc_info_lapack(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_opt_info=_calc_info_lapack=1881')
    ...
    def _calc_info_from_envvar(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_opt_info=_calc_info_from_envvar=1891')
        info = {}
        info['language'] = 'f77'
        info['libraries'] = []
        info['include_dirs'] = []
    ...
    def _calc_info(self, name):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_opt_info=_calc_info=1901')
        return getattr(self, '_calc_info_{}'.format(name))()
    
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_opt_info=calc_info=1904')
...
class _ilp64_opt_info_mixin:
    ...
    def _check_info(self, info):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=_ilp64_opt_info_mixin=_check_info=1932')
...
class lapack_ilp64_opt_info(lapack_opt_info, _ilp64_opt_info_mixin):
    ...
    def _calc_info(self, name):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=lapack_ilp64_opt_info=_calc_info=1951')
...
class blas_opt_info(system_info):
    ...
    def _calc_info_armpl(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blas_opt_info=_calc_info_armpl=1978')
    ...
    def _calc_info_mkl(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blas_opt_info=_calc_info_mkl=1985')
    ...
    def _calc_info_blis(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blas_opt_info=_calc_info_blis=1992')
        info = get_info('blis')
        if info:
            self.set_info(**info)
            return True
    ...
    def _calc_info_openblas(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blas_opt_info=_calc_info_openblas=1999')
    ...
    def _calc_info_atlas(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blas_opt_info=_calc_info_atlas=2006')
    ...
    def _calc_info_accelerate(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blas_opt_info=_calc_info_accelerate=2019')
        info = get_info('accelerate')
        if info:
            self.set_info(**info)
            return True
    ...
    def _calc_info_blas(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blas_opt_info=_calc_info_blas=2026')
    ...
    def _calc_info_from_envvar(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blas_opt_info=_calc_info_from_envvar=2048')
        info = {}
        info['language'] = 'f77'
        info['libraries'] = []
        info['include_dirs'] = []
    ...
    def _calc_info(self, name):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blas_opt_info=_calc_info=2062')
        return getattr(self, '_calc_info_{}'.format(name))()
    
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blas_opt_info=calc_info=2065')
...
class blas_ilp64_opt_info(blas_opt_info, _ilp64_opt_info_mixin):
    ...
    def _calc_info(self, name):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blas_ilp64_opt_info=_calc_info=2092')
        info = get_info(name)
        if self._check_info(info):
            self.set_info(**info)
            return True
...
class blas_info(system_info):
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blas_info=calc_info=2124')
        lib_dirs = self.get_lib_dirs()
    ...
    def get_cblas_libs(self, info):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blas_info=get_cblas_libs=2154')
        c = customized_ccompiler()
...
class openblas_info(blas_info):
    ...
    def symbol_prefix(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=openblas_info=symbol_prefix=2227')
        try:
    ...
    def symbol_suffix(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=openblas_info=symbol_suffix=2234')
        try:
    ...
    def _calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=openblas_info=_calc_info=2241')
        c = customized_ccompiler()
        lib_dirs = self.get_lib_dirs()
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=openblas_info=calc_info=2282')
        info = self._calc_info()
        if info is not None:
            self.set_info(**info)
    
    def check_msvc_gfortran_libs(self, library_dirs, libraries):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=openblas_info=check_msvc_gfortran_libs=2287')
        library_paths = []
    ...
    def check_symbols(self, info):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=openblas_info=check_symbols=2319')
        res = False
        c = customized_ccompiler()
        tmpdir = tempfile.mkdtemp()
...
class openblas_ilp64_info(openblas_info):
    ...
    def _calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=openblas_ilp64_info=_calc_info=2379')
...
class openblas_ilp64_lapack_info(openblas_ilp64_info):
    ...
    def _calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=openblas_ilp64_lapack_info=_calc_info=2388')
        info = super()._calc_info()
        if info:
...
class blis_info(blas_info):
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blis_info=calc_info=2411')
        lib_dirs = self.get_lib_dirs()
...
class flame_info(system_info):
    ...
    def check_embedded_lapack(self, info):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=flame_info=check_embedded_lapack=2442')
        c = customized_ccompiler()
        tmpdir = tempfile.mkdtemp()
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=flame_info=calc_info=2472')
        lib_dirs = self.get_lib_dirs()
...
class accelerate_info(system_info):
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=accelerate_info=calc_info=2513')
...
class blas_src_info(system_info):
    ...
    def get_paths(self, section, key):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blas_src_info=get_paths=2566')
        pre_dirs = system_info.get_paths(self, section, key)
        dirs = []
        for d in pre_dirs:
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=blas_src_info=calc_info=2573')
        src_dirs = self.get_src_dirs()
        src_dir = ''
        for d in src_dirs:
...
class x11_info(system_info):
    ...
    def __init__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=x11_info=__init__=2618')
        system_info.__init__(self, default_lib_dirs=default_x11_lib_dirs, default_include_dirs=default_x11_include_dirs)
    
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=x11_info=calc_info=2623')
...
class _numpy_info(system_info):
    ...
    def __init__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=_numpy_info=__init__=2648')
        include_dirs = []
        try:
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=_numpy_info=calc_info=2681')
        try:
            module = __import__(self.modulename)
        except ImportError:
            return
...
class numerix_info(system_info):
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=numerix_info=calc_info=2730')
        which = (None, None)
...
class f2py_info(system_info):
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=f2py_info=calc_info=2765')
        try:
...
class boost_python_info(system_info):
    ...
    def get_paths(self, section, key):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=boost_python_info=get_paths=2780')
        pre_dirs = system_info.get_paths(self, section, key)
        dirs = []
        for d in pre_dirs:
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=boost_python_info=calc_info=2787')
        src_dirs = self.get_src_dirs()
        src_dir = ''
        for d in src_dirs:
...
class agg2_info(system_info):
    ...
    def get_paths(self, section, key):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=agg2_info=get_paths=2819')
        pre_dirs = system_info.get_paths(self, section, key)
        dirs = []
        for d in pre_dirs:
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=agg2_info=calc_info=2826')
        src_dirs = self.get_src_dirs()
        src_dir = ''
        for d in src_dirs:
...
class _pkg_config_info(system_info):
    ...
    def get_config_exe(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=_pkg_config_info=get_config_exe=2867')
        if self.config_env_var in os.environ:
            return os.environ[self.config_env_var]
        return self.default_config_exe
    
    def get_config_output(self, config_exe, option):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=_pkg_config_info=get_config_output=2872')
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=_pkg_config_info=calc_info=2882')
...
class amd_info(system_info):
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=amd_info=calc_info=3016')
        lib_dirs = self.get_lib_dirs()
...
class umfpack_info(system_info):
    ...
    def calc_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=umfpack_info=calc_info=3048')
        lib_dirs = self.get_lib_dirs()
...
def combine_paths(*args, **kws):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=combine_paths=3076')
    r = []
    for a in args:
        if not a:
            continue
...
def dict_append(d, **kws):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=dict_append=3106')
    languages = []
...
def parseCmdLine(argv=(None, )):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=parseCmdLine=3127')
    import optparse
...
def show_all(argv=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/system_info.py=show_all=3138')
    import inspect
    if argv is None:
        argv = sys.argv
