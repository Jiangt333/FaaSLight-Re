...
def customized_fcompiler(plat=None, compiler=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/__init__.py=customized_fcompiler=55')
...
def customized_ccompiler(plat=None, compiler=None, verbose=1):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/distutils/__init__.py=customized_ccompiler=61')
