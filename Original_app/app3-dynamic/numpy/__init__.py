...
if __NUMPY_SETUP__:
    ...
    def __getattr__(attr):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/__init__.py=__getattr__=272')
        import warnings
        try:
            ...
            def _expired(*args, **kwds):
                print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/__init__.py=__getattr__=_expired=283')
        ...
        if attr in __future_scalars__:
            warnings.warn(f'In the future `np.{attr}` will be defined as the corresponding NumPy scalar.', FutureWarning, stacklevel=2)
    ...
    def __dir__():
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/__init__.py=__dir__=323')
    ...
    def _sanity_check():
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/__init__.py=_sanity_check=335')
        try:
    ...
    def _mac_os_check():
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/__init__.py=_mac_os_check=361')
        try:
            c = array([3.0, 2.0, 1.0])
            x = linspace(0, 2, 5)
            y = polyval(c, x)
    ...
    def _pyinstaller_hooks_dir():
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/__init__.py=_pyinstaller_hooks_dir=427')
