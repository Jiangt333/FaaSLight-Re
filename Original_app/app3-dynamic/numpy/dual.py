...
def register_func(name, func):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/dual.py=register_func=64')
...
def restore_func(name):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/dual.py=restore_func=71')
    if name not in __all__:
        raise ValueError('{} not a dual function.'.format(name))
    try:
...
def restore_all():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/dual.py=restore_all=81')
