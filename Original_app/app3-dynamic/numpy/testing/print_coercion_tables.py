...
class GenericObject:
    ...
    def __init__(self, v):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/print_coercion_tables.py=GenericObject=__init__=10')
        self.v = v
    
    def __add__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/print_coercion_tables.py=GenericObject=__add__=13')
        return self
    
    def __radd__(self, other):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/print_coercion_tables.py=GenericObject=__radd__=16')
        return self
    dtype = np.dtype('O')


def print_cancast_table(ntypes):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/print_coercion_tables.py=print_cancast_table=21')
    print('X', end=' ')
    for char in ntypes:
        print(char, end=' ')
    print()
...
def print_coercion_table(ntypes, inputfirstvalue, inputsecondvalue, firstarray, use_promote_types=False):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/print_coercion_tables.py=print_coercion_table=42')
    print('+', end=' ')
    for char in ntypes:
        print(char, end=' ')
    print()
...
def print_new_cast_table(*, can_cast=True, legacy=False, flags=False):
    ...
    actual ones.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/print_coercion_tables.py=print_new_cast_table=83')
    ...
    def sorter(x):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/print_coercion_tables.py=print_new_cast_table=sorter=134')
    ...
    def print_table(field='can_cast'):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/print_coercion_tables.py=print_new_cast_table=print_table=146')
        print('X', end=' ')
        for dt in dtypes:
