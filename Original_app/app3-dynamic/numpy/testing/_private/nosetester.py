...
def get_package_name(filepath):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/_private/nosetester.py=get_package_name=20')
    fullpath = filepath[:]
    pkg_name = []
...
def run_module_suite(file_to_run=None, argv=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/_private/nosetester.py=run_module_suite=61')
...
class NoseTester:
    ...
    def __init__(self, package=None, raise_warnings='release', depth=0, check_fpu_mode=False):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/_private/nosetester.py=NoseTester=__init__=154')
    ...
    def _test_argv(self, label, verbose, extra_argv):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/_private/nosetester.py=NoseTester=_test_argv=195')
    ...
    def _show_system_info(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/_private/nosetester.py=NoseTester=_show_system_info=232')
        nose = import_nose()
        import numpy
    ...
    def _get_custom_doctester(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/_private/nosetester.py=NoseTester=_get_custom_doctester=252')
    ...
    def prepare_test_args(self, label='fast', verbose=1, extra_argv=None, doctests=False, coverage=False, timer=False):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/_private/nosetester.py=NoseTester=prepare_test_args=262')
        import_nose()
    ...
    def test(self, label='fast', verbose=1, extra_argv=None, doctests=False, coverage=False, raise_warnings=None, timer=False):
        ...
        []
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/_private/nosetester.py=NoseTester=test=326')
    ...
    def bench(self, label='fast', verbose=1, extra_argv=None):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/_private/nosetester.py=NoseTester=bench=465')
...
def _numpy_tester():
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/testing/_private/nosetester.py=_numpy_tester=539')
