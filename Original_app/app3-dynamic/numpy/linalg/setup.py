...
def configuration(parent_package='', top_path=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/linalg/setup.py=configuration=5')
    ...
    if use_lapack_lite:
        ...
        class numpy_linalg_lapack_lite(system_info):
            ...
            def calc_info(self):
                print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/linalg/setup.py=configuration=numpy_linalg_lapack_lite=calc_info=40')
                info = {'language': 'c'}
    ...
    def get_lapack_lite_sources(ext, build_dir):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/linalg/setup.py=configuration=get_lapack_lite_sources=61')
        if use_lapack_lite:
    ...
    config.add_extension('_umath_linalg', sources=['umath_linalg.cpp', get_lapack_lite_sources], depends=['lapack_lite/f2c.h'], extra_info=lapack_info, extra_cxx_compile_args=NPY_CXX_FLAGS, libraries=['npymath'])
