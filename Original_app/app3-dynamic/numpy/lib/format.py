...
def _check_version(version):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=_check_version=196')
...
def magic(major, minor):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=magic=201')
...
def read_magic(fp):
    ...
    minor : int
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=read_magic=223')
...
def _has_metadata(dt):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=_has_metadata=242')
...
def dtype_to_descr(dtype):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=dtype_to_descr=252')
    if _has_metadata(dtype):
        warnings.warn('metadata on a dtype may be saved or ignored, but will raise if saved when read. Use another form of storage.', UserWarning, stacklevel=2)
...
def descr_to_dtype(descr):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=descr_to_dtype=288')
...
def header_data_from_array_1_0(array):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=header_data_from_array_1_0=344')
    d = {'shape': array.shape}
...
def _wrap_header(header, version):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=_wrap_header=372')
    import struct
...
def _wrap_header_guess_version(header):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=_wrap_header_guess_version=396')
    try:
...
def _write_array_header(fp, d, version=None):
    ...
    version : tuple or None
        ...
        Default: None
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=_write_array_header=420')
    header = ['{']
...
def write_array_header_1_0(fp, d):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=write_array_header_1_0=455')
...
def write_array_header_2_0(fp, d):
    ...
    d : dict
        ...
        representation to the header of the file.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=write_array_header_2_0=468')
...
def read_array_header_1_0(fp, max_header_size=_MAX_HEADER_SIZE):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=read_array_header_1_0=483')
...
def read_array_header_2_0(fp, max_header_size=_MAX_HEADER_SIZE):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=read_array_header_2_0=519')
...
def _filter_header(s):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=_filter_header=558')
    import tokenize
...
def _read_array_header(fp, version, max_header_size=_MAX_HEADER_SIZE):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=_read_array_header=593')
    import struct
...
def write_array(fp, array, version=None, allow_pickle=True, pickle_kwargs=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=write_array=658')
...
def read_array(fp, allow_pickle=False, pickle_kwargs=None, *, max_header_size=_MAX_HEADER_SIZE):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=read_array=730')
    if allow_pickle:
...
def open_memmap(filename, mode='r+', dtype=None, shape=None, fortran_order=False, version=None, *, max_header_size=_MAX_HEADER_SIZE):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=open_memmap=836')
...
def _read_bytes(fp, size, error_template='ran out of data'):
    ...
    requested.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/format.py=_read_bytes=943')
    data = bytes()
    while True:
        try:
