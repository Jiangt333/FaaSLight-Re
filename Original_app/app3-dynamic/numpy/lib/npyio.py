...
__all__ = ['savetxt', 'loadtxt', 'genfromtxt', 'recfromtxt', 'recfromcsv', 'load', 'save', 'savez', 'savez_compressed', 'packbits', 'unpackbits', 'fromregex', 'DataSource']
...
class BagObj:
    ...
    def __init__(self, obj):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=BagObj=__init__=72')
        self._obj = weakref.proxy(obj)
    
    def __getattribute__(self, key):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=BagObj=__getattribute__=76')
        try:
    ...
    def __dir__(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=BagObj=__dir__=82')
...
def zipfile_factory(file, *args, **kwargs):
    ...
    constructor.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=zipfile_factory=91')
...
class NpzFile(Mapping):
    ...
    def __init__(self, fid, own_fid=False, allow_pickle=False, pickle_kwargs=None, *, max_header_size=format._MAX_HEADER_SIZE):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=NpzFile=__init__=182')
    ...
    def __enter__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=NpzFile=__enter__=203')
        return self
    
    def __exit__(self, exc_type, exc_value, traceback):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=NpzFile=__exit__=206')
        self.close()
    ...
    def close(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=NpzFile=close=209')
    ...
    def __del__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=NpzFile=__del__=222')
        self.close()
    
    def __iter__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=NpzFile=__iter__=226')
        return iter(self.files)
    
    def __len__(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=NpzFile=__len__=229')
        return len(self.files)
    
    def __getitem__(self, key):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=NpzFile=__getitem__=232')
        member = False
...
def load(file, mmap_mode=None, allow_pickle=False, fix_imports=True, encoding='ASCII', *, max_header_size=format._MAX_HEADER_SIZE):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=load=263')
...
def _save_dispatcher(file, arr, allow_pickle=None, fix_imports=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=_save_dispatcher=447')
    return (arr, )
...
def save(file, arr, allow_pickle=True, fix_imports=True):
    ...
    # [1 2] [1 3]
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=save=451')
...
def _savez_dispatcher(file, *args, **kwds):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=_savez_dispatcher=526')
    yield from args
...
def savez(file, *args, **kwds):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=savez=531')
    _savez(file, args, kwds, False)

def _savez_compressed_dispatcher(file, *args, **kwds):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=_savez_compressed_dispatcher=618')
    yield from args
    yield from kwds.values()
...
def savez_compressed(file, *args, **kwds):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=savez_compressed=623')
    _savez(file, args, kwds, True)

def _savez(file, args, kwds, compress, allow_pickle=True, pickle_kwargs=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=_savez=689')
    import zipfile
...
def _ensure_ndmin_ndarray_check_param(ndmin):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=_ensure_ndmin_ndarray_check_param=726')
...
def _ensure_ndmin_ndarray(a, *, ndmin: int):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=_ensure_ndmin_ndarray=736')
    if a.ndim > ndmin:
        a = np.squeeze(a)
    if a.ndim < ndmin:
        if ndmin == 1:
...
def _loadtxt_dispatcher(fname, dtype=None, comments=None, delimiter=None, converters=None, skiprows=None, usecols=None, unpack=None, ndmin=None, encoding=None, max_rows=None, *, like=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=_loadtxt_dispatcher=763')
    return (like, )

def _check_nonneg_int(value, name='argument'):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=_check_nonneg_int=770')
    try:
...
def _preprocess_comments(iterable, comments, encoding):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=_preprocess_comments=779')
...
def _read(fname, *, delimiter=',', comment='#', quote='"', imaginary_unit='j', usecols=None, skiplines=0, max_rows=None, converters=None, ndmin=None, unpack=False, dtype=np.float64, encoding='bytes'):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=_read=801')
...
def loadtxt(fname, dtype=float, comments='#', delimiter=None, converters=None, skiprows=0, usecols=None, unpack=False, ndmin=0, encoding='bytes', max_rows=None, *, quotechar=None, like=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=loadtxt=1081')
    if like is not None:
        return _loadtxt_with_like(fname, dtype=dtype, comments=comments, delimiter=delimiter, converters=converters, skiprows=skiprows, usecols=usecols, unpack=unpack, ndmin=ndmin, encoding=encoding, max_rows=max_rows, like=like)
...
def _savetxt_dispatcher(fname, X, fmt=None, delimiter=None, newline=None, header=None, footer=None, comments=None, encoding=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=_savetxt_dispatcher=1369')
    return (X, )
...
def savetxt(fname, X, fmt='%.18e', delimiter=' ', newline='\n', header='', footer='', comments='# ', encoding=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=savetxt=1375')
    ...
    class WriteWrap:
        ...
        def __init__(self, fh, encoding):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=savetxt=WriteWrap=__init__=1507')
            self.fh = fh
            self.encoding = encoding
            self.do_write = self.first_write
        
        def close(self):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=savetxt=WriteWrap=close=1512')
            self.fh.close()
        
        def write(self, v):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=savetxt=WriteWrap=write=1515')
            self.do_write(v)
        
        def write_bytes(self, v):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=savetxt=WriteWrap=write_bytes=1518')
        ...
        def write_normal(self, v):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=savetxt=WriteWrap=write_normal=1524')
            self.fh.write(asunicode(v))
        
        def first_write(self, v):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=savetxt=WriteWrap=first_write=1527')
            try:
                self.write_normal(v)
...
def fromregex(file, regexp, dtype, encoding=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=fromregex=1623')
    own_fh = False
    if not hasattr(file, 'read'):
        file = os.fspath(file)
...
def _genfromtxt_dispatcher(fname, dtype=None, comments=None, delimiter=None, skip_header=None, skip_footer=None, converters=None, missing_values=None, filling_values=None, usecols=None, names=None, excludelist=None, deletechars=None, replace_space=None, autostrip=None, case_sensitive=None, defaultfmt=None, unpack=None, usemask=None, loose=None, invalid_raise=None, max_rows=None, encoding=None, *, ndmin=None, like=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=_genfromtxt_dispatcher=1727')
    return (like, )
...
def genfromtxt(fname, dtype=float, comments='#', delimiter=None, skip_header=0, skip_footer=0, converters=None, missing_values=None, filling_values=None, usecols=None, names=None, excludelist=None, deletechars=''.join(sorted(NameValidator.defaultdeletechars)), replace_space='_', autostrip=False, case_sensitive=True, defaultfmt='f%i', unpack=None, usemask=False, loose=True, invalid_raise=True, max_rows=None, encoding='bytes', *, ndmin=0, like=None):
    ...
    * Individual values are not stripped of spaces by default.
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=genfromtxt=1738')
    if like is not None:
        return _genfromtxt_with_like(fname, dtype=dtype, comments=comments, delimiter=delimiter, skip_header=skip_header, skip_footer=skip_footer, converters=converters, missing_values=missing_values, filling_values=filling_values, usecols=usecols, names=names, excludelist=excludelist, deletechars=deletechars, replace_space=replace_space, autostrip=autostrip, case_sensitive=case_sensitive, defaultfmt=defaultfmt, unpack=unpack, usemask=usemask, loose=loose, invalid_raise=invalid_raise, max_rows=max_rows, encoding=encoding, ndmin=ndmin, like=like)
    _ensure_ndmin_ndarray_check_param(ndmin)
    if max_rows is not None:
        if skip_footer:
        ...
        for (j, conv) in user_converters.items():
            ...
            if conv is bytes:
                ...
                def tobytes_first(x, conv):
                    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=genfromtxt=tobytes_first=2213')
                    if type(x) is bytes:
                        return conv(x)
    ...
    if dtype is None:
        ...
        if (byte_converters and strcolidx):
            warnings.warn('Reading unicode strings without specifying the encoding argument is deprecated. Set the encoding, use None for the system default.', np.VisibleDeprecationWarning, stacklevel=2)
            
            def encode_unicode_cols(row_tup):
                print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=genfromtxt=encode_unicode_cols=2347')
                row = list(row_tup)
                for i in strcolidx:
...
def recfromtxt(fname, **kwargs):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=recfromtxt=2479')
...
def recfromcsv(fname, **kwargs):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/npyio.py=recfromcsv=2511')
