...
def show_runtime():
    ...
    [{'simd_extensions': {'baseline': ['SSE', 'SSE2', 'SSE3'],
     ...
     {'architecture': 'Zen',
      ...
      'version': '0.3.20'}]
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=show_runtime=21')
...
def get_include():
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=get_include=97')
    import numpy
...
class _Deprecate:
    ...
    def __init__(self, old_name=None, new_name=None, message=None):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=_Deprecate=__init__=138')
    ...
    def __call__(self, func, *args, **kwargs):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=_Deprecate=__call__=143')
        ...
        def newfunc(*args, **kwds):
            print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=_Deprecate=__call__=newfunc=163')
...
def _get_indent(lines):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=_get_indent=194')
    indent = sys.maxsize
    for line in lines:
...
def deprecate(*args, **kwargs):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=deprecate=208')
    if args:
        fn = args[0]
        args = args[1:]
...
def deprecate_with_doc(msg):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=deprecate_with_doc=261')
...
def byte_bounds(a):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=byte_bounds=292')
...
def who(vardict=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=who=349')
    if vardict is None:
    ...
    if len(sta) > 0:
        ...
        print(prval + '\n' + '=' * (len(prval) + 5) + '\n')
    for val in sta:
        print('%s %s %s %s %s %s %s' % (val[0], ' ' * (sp1 - len(val[0]) + 4), val[1], ' ' * (sp2 - len(val[1]) + 5), val[2], ' ' * (sp3 - len(val[2]) + 5), val[3]))
    print('\nUpper bound on total bytes  =       %d' % totalbytes)
    return

def _split_line(name, arguments, width):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=_split_line=452')
    firstwidth = len(name)
    k = firstwidth
    newstr = name
    sepstr = ', '
...
def _makenamedict(module='numpy'):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=_makenamedict=476')
...
def _info(obj, output=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=_info=496')
    extra = ''
    tic = ''
    bp = lambda x: x
...
def info(object=None, maxwidth=76, output=None, toplevel='numpy'):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=info=550')
...
def source(object, output=sys.stdout):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=source=700')
    import inspect
    try:
...
def lookfor(what, module=None, import_modules=True, regenerate=False, output=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=lookfor=759')
    import pydoc
    ...
    def relevance(name, docstr, kind, index):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=lookfor=relevance=833')
        r = 0
    ...
    def relevance_value(a):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=lookfor=relevance_value=849')
...
def _lookfor_generate_cache(module, import_modules, regenerate):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=_lookfor_generate_cache=883')
    import inspect
...
def _getmembers(item):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=_getmembers=1022')
    import inspect
    try:
...
def safe_eval(source):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=safe_eval=1032')
    import ast
...
def _median_nancheck(data, result, axis):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=_median_nancheck=1086')
    if data.size == 0:
        return result
...
def _opt_info():
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/utils.py=_opt_info=1122')
    from numpy.core._multiarray_umath import __cpu_features__, __cpu_baseline__, __cpu_dispatch__
