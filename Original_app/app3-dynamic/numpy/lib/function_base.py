...
from numpy.core.multiarray import _insert, add_docstring, bincount, normalize_axis_index, _monotonicity, interp as compiled_interp, interp_complex as compiled_interp_complex
...
def _rot90_dispatcher(m, k=None, axes=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_rot90_dispatcher=154')
    return (m, )
...
def rot90(m, k=1, axes=(0, 1)):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=rot90=158')
    axes = tuple(axes)
    if len(axes) != 2:
...
def _flip_dispatcher(m, axis=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_flip_dispatcher=248')
    return (m, )
...
def flip(m, axis=None):
    ...
    True
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=flip=252')
...
def iterable(y):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=iterable=346')
    try:
        iter(y)
    except TypeError:
        return False
...
def _average_dispatcher(a, axis=None, weights=None, returned=None, *, keepdims=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_average_dispatcher=391')
    return (a, weights)
...
def average(a, axis=None, weights=None, returned=False, *, keepdims=np._NoValue):
    ...
    array([[0.5],
           ...
           [4.5]])
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=average=396')
    a = np.asanyarray(a)
...
def asarray_chkfinite(a, dtype=None, order=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=asarray_chkfinite=562')
...
def _piecewise_dispatcher(x, condlist, funclist, *args, **kw):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_piecewise_dispatcher=633')
    yield x
...
def piecewise(x, condlist, funclist, *args, **kw):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=piecewise=640')
    x = asanyarray(x)
    n2 = len(funclist)
...
def _select_dispatcher(condlist, choicelist, default=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_select_dispatcher=761')
    yield from condlist
...
def select(condlist, choicelist, default=0):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=select=766')
...
def _copy_dispatcher(a, order=None, subok=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_copy_dispatcher=867')
    return (a, )
...
def copy(a, order='K', subok=False):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=copy=871')
    return array(a, order=order, subok=subok, copy=True)

def _gradient_dispatcher(f, *varargs, axis=None, edge_order=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_gradient_dispatcher=965')
    yield f
    yield from varargs
...
def gradient(f, *varargs, axis=None, edge_order=1):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=gradient=970')
    f = np.asanyarray(f)
    N = f.ndim
    if axis is None:
        axes = tuple(range(N))
...
def _diff_dispatcher(a, n=None, axis=None, prepend=None, append=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_diff_dispatcher=1316')
...
def diff(a, n=1, axis=-1, prepend=np._NoValue, append=np._NoValue):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=diff=1320')
    if n == 0:
        return a
    if n < 0:
...
def _interp_dispatcher(x, xp, fp, left=None, right=None, period=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_interp_dispatcher=1453')
    return (x, xp, fp)
...
def interp(x, xp, fp, left=None, right=None, period=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=interp=1457')
    fp = np.asarray(fp)
...
def _angle_dispatcher(z, deg=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_angle_dispatcher=1598')
    return (z, )
...
def angle(z, deg=False):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=angle=1602')
    z = asanyarray(z)
...
def _unwrap_dispatcher(p, discont=None, axis=None, *, period=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_unwrap_dispatcher=1655')
    return (p, )
...
def unwrap(p, discont=None, axis=-1, *, period=2 * pi):
    ...
    array([-180., -140., -100.,  -60.,  -20.,   20.,   60.,  100.,  140.,
            ...
            540.])
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=unwrap=1659')
    p = asarray(p)
    nd = p.ndim
    dd = diff(p, axis=axis)
    if discont is None:
...
def _sort_complex(a):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_sort_complex=1755')
    return (a, )
...
def sort_complex(a):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=sort_complex=1759')
    b = array(a, copy=True)
    b.sort()
...
def _trim_zeros(filt, trim=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_trim_zeros=1796')
    return (filt, )
...
def trim_zeros(filt, trim='fb'):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=trim_zeros=1800')
    first = 0
    trim = trim.upper()
    if 'F' in trim:
        for i in filt:
...
def _extract_dispatcher(condition, arr):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_extract_dispatcher=1853')
...
def extract(condition, arr):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=extract=1857')
    return _nx.take(ravel(arr), nonzero(ravel(condition))[0])

def _place_dispatcher(arr, mask, vals):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_place_dispatcher=1909')
...
def place(arr, mask, vals):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=place=1913')
...
def disp(mesg, device=None, linefeed=True):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=disp=1957')
    if device is None:
        device = sys.stdout
    if linefeed:
        device.write('%s\n' % mesg)
...
def _parse_gufunc_signature(signature):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_parse_gufunc_signature=2007')
...
def _update_dim_sizes(dim_sizes, arg, core_dims):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_update_dim_sizes=2032')
    if not core_dims:
        return
...
def _parse_input_dimensions(args, input_core_dims):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_parse_input_dimensions=2066')
    broadcast_args = []
    dim_sizes = {}
...
def _calculate_shapes(broadcast_shape, dim_sizes, list_of_core_dims):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_calculate_shapes=2095')
...
def _create_arrays(broadcast_shape, dim_sizes, list_of_core_dims, dtypes, results=None):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_create_arrays=2101')
...
class vectorize:
    ...
    def __init__(self, pyfunc, otypes=None, doc=None, excluded=None, cache=False, signature=None):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=vectorize=__init__=2269')
        self.pyfunc = pyfunc
        self.cache = cache
    ...
    def __call__(self, *args, **kwargs):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=vectorize=__call__=2301')
        ...
        if (not kwargs and not excluded):
            ...
            def func(*vargs):
                print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=vectorize=__call__=func=2320')
    ...
    def _get_ufunc_and_otypes(self, func, args):
        """Return (ufunc, otypes)."""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=vectorize=_get_ufunc_and_otypes=2331')
        if not args:
        ...
        if self.otypes is not None:
            ...
            if self.cache:
                ...
                def _func(*vargs):
                    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=vectorize=_get_ufunc_and_otypes=_func=2376')
                    if _cache:
                        return _cache.pop()
                    else:
                        return func(*vargs)
    ...
    def _vectorize_call(self, func, args):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=vectorize=_vectorize_call=2400')
    ...
    def _vectorize_call_with_signature(self, func, args):
        ...
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=vectorize=_vectorize_call_with_signature=2421')
...
def _cov_dispatcher(m, y=None, rowvar=None, bias=None, ddof=None, fweights=None, aweights=None, *, dtype=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_cov_dispatcher=2482')
...
def cov(m, y=None, rowvar=True, bias=False, ddof=None, fweights=None, aweights=None, *, dtype=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=cov=2487')
...
def _corrcoef_dispatcher(x, y=None, rowvar=None, bias=None, ddof=None, *, dtype=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_corrcoef_dispatcher=2709')
    return (x, y)
...
def corrcoef(x, y=None, rowvar=True, bias=np._NoValue, ddof=np._NoValue, *, dtype=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=corrcoef=2714')
...
def blackman(M):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=blackman=2867')
    if M < 1:
...
def bartlett(M):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=bartlett=2967')
    if M < 1:
        return array([], dtype=np.result_type(M, 0.0))
    if M == 1:
        return ones(1, dtype=np.result_type(M, 0.0))
...
def hanning(M):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=hanning=3075')
    if M < 1:
        return array([], dtype=np.result_type(M, 0.0))
    if M == 1:
        return ones(1, dtype=np.result_type(M, 0.0))
...
def hamming(M):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=hamming=3179')
    if M < 1:
        return array([], dtype=np.result_type(M, 0.0))
    if M == 1:
        return ones(1, dtype=np.result_type(M, 0.0))
...
def _chbevl(x, vals):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_chbevl=3343')
    b0 = vals[0]
    b1 = 0.0
...
def _i0_1(x):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_i0_1=3355')
    return exp(x) * _chbevl(x / 2.0 - 2, _i0A)

def _i0_2(x):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_i0_2=3359')
    return exp(x) * _chbevl(32.0 / x - 2.0, _i0B) / sqrt(x)

def _i0_dispatcher(x):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_i0_dispatcher=3363')
    return (x, )
...
def i0(x):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=i0=3367')
    x = np.asanyarray(x)
    if x.dtype.kind == 'c':
...
def kaiser(M, beta):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=kaiser=3429')
    if M == 1:
...
def _sinc_dispatcher(x):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_sinc_dispatcher=3557')
    return (x, )
...
def sinc(x):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=sinc=3561')
    x = np.asanyarray(x)
    y = pi * where(x == 0, 1e-20, x)
    return sin(y) / y

def _msort_dispatcher(a):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_msort_dispatcher=3642')
    return (a, )
...
def msort(a):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=msort=3646')
    warnings.warn('msort is deprecated, use np.sort(a, axis=0) instead', DeprecationWarning, stacklevel=3)
...
def _ureduce(a, func, keepdims=False, **kwargs):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_ureduce=3692')
    a = np.asanyarray(a)
...
def _median_dispatcher(a, axis=None, out=None, overwrite_input=None, keepdims=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_median_dispatcher=3769')
    return (a, out)
...
def median(a, axis=None, out=None, overwrite_input=False, keepdims=False):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=median=3774')
    return _ureduce(a, func=_median, keepdims=keepdims, axis=axis, out=out, overwrite_input=overwrite_input)

def _median(a, axis=None, out=None, overwrite_input=False):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_median=3860')
    a = np.asanyarray(a)
    if axis is None:
        sz = a.size
    else:
...
def _percentile_dispatcher(a, q, axis=None, out=None, overwrite_input=None, method=None, keepdims=None, *, interpolation=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_percentile_dispatcher=3915')
    return (a, q, out)
...
def percentile(a, q, axis=None, out=None, overwrite_input=False, method='linear', keepdims=False, *, interpolation=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=percentile=3920')
...
def _quantile_dispatcher(a, q, axis=None, out=None, overwrite_input=None, method=None, keepdims=None, *, interpolation=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_quantile_dispatcher=4209')
    return (a, q, out)
...
def quantile(a, q, axis=None, out=None, overwrite_input=False, method='linear', keepdims=False, *, interpolation=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=quantile=4214')
    if interpolation is not None:
...
def _quantile_unchecked(a, q, axis=None, out=None, overwrite_input=False, method='linear', keepdims=False):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_quantile_unchecked=4465')
...
def _quantile_is_valid(q):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_quantile_is_valid=4483')
    if (q.ndim == 1 and q.size < 10):
        for i in range(q.size):
            if not 0.0 <= q[i] <= 1.0:
                return False
    elif not ((np.all(0 <= q) and np.all(q <= 1))):
        return False
    return True

def _check_interpolation_as_method(method, interpolation, fname):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_check_interpolation_as_method=4495')
...
def _compute_virtual_index(n, quantiles, alpha: float, beta: float):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_compute_virtual_index=4512')
...
def _get_gamma(virtual_indexes, previous_indexes, method):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_get_gamma=4537')
...
def _lerp(a, b, t, out=None):
    ...
    out : array_like
        Output array.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_lerp=4559')
...
def _get_gamma_mask(shape, default_value, conditioned_value, where):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_get_gamma_mask=4582')
...
def _discret_interpolation_to_boundaries(index, gamma_condition_fun):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_discret_interpolation_to_boundaries=4588')
...
def _closest_observation(n, quantiles):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_closest_observation=4602')
...
def _inverted_cdf(n, quantiles):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_inverted_cdf=4608')
...
def _quantile_ureduce_func(a: np.array, q: np.array, axis: int = None, out=None, overwrite_input: bool = False, method='linear') -> np.array:
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_quantile_ureduce_func=4614')
    if q.ndim > 2:
...
def _get_indexes(arr, virtual_indexes, valid_values_count):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_get_indexes=4647')
...
def _quantile(arr: np.array, quantiles: np.array, axis: int = -1, method='linear', out=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_quantile=4682')
    ...
    if np.issubdtype(virtual_indexes.dtype, np.integer):
        ...
        arr.partition(np.unique(np.concatenate(([0, -1], previous_indexes.ravel(), next_indexes.ravel()))), axis=DATA_AXIS)
        if np.issubdtype(arr.dtype, np.inexact):
...
def _trapz_dispatcher(y, x=None, dx=None, axis=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_trapz_dispatcher=4769')
    return (y, x)
...
def trapz(y, x=None, dx=1.0, axis=-1):
    ...
    array([2.,  8.])
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=trapz=4773')
    y = asanyarray(y)
    if x is None:
        d = dx
    else:
...
def _meshgrid_dispatcher(*xi, copy=None, sparse=None, indexing=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_meshgrid_dispatcher=4887')
    return xi
...
def meshgrid(*xi, copy=True, sparse=False, indexing='xy'):
    ...
    >>> plt.show()
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=meshgrid=4892')
    ndim = len(xi)
...
def _delete_dispatcher(arr, obj, axis=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_delete_dispatcher=5050')
    return (arr, obj)
...
def delete(arr, obj, axis=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=delete=5054')
    wrap = None
...
def _insert_dispatcher(arr, obj, values, axis=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_insert_dispatcher=5246')
...
def insert(arr, obj, values, axis=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=insert=5250')
    wrap = None
    if type(arr) is not ndarray:
        try:
            wrap = arr.__array_wrap__
    ...
    if isinstance(obj, slice):
        ...
        if indices.dtype == bool:
            warnings.warn('in the future insert will treat boolean arrays and array-likes as a boolean index instead of casting it to integer', FutureWarning, stacklevel=3)
...
def _append_dispatcher(arr, values, axis=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_append_dispatcher=5440')
    return (arr, values)
...
def append(arr, values, axis=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=append=5444')
    arr = asanyarray(arr)
    if axis is None:
        if arr.ndim != 1:
            arr = arr.ravel()
...
def _digitize_dispatcher(x, bins, right=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=_digitize_dispatcher=5502')
    return (x, bins)
...
def digitize(x, bins, right=False):
    ...
    array([1, 3, 3, 4, 5])
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/function_base.py=digitize=5506')
    x = _nx.asarray(x)
