...
def _ptp(x):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_ptp=22')
...
def _hist_bin_sqrt(x, range):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_hist_bin_sqrt=32')
    del range
...
def _hist_bin_sturges(x, range):
    ...
    h : An estimate of the optimal bin width for the given data.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_hist_bin_sturges=53')
    del range
...
def _hist_bin_rice(x, range):
    ...
    h : An estimate of the optimal bin width for the given data.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_hist_bin_rice=76')
    del range
...
def _hist_bin_scott(x, range):
    ...
    h : An estimate of the optimal bin width for the given data.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_hist_bin_scott=100')
    del range
...
def _hist_bin_stone(x, range):
    ...
    h : An estimate of the optimal bin width for the given data.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_hist_bin_stone=122')
    n = x.size
    ptp_x = _ptp(x)
    if (n <= 1 or ptp_x == 0):
        return 0
    ...
    def jhat(nbins):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_hist_bin_stone=jhat=151')
        hh = ptp_x / nbins
...
def _hist_bin_doane(x, range):
    ...
    h : An estimate of the optimal bin width for the given data.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_hist_bin_doane=164')
    del range
    if x.size > 2:
...
def _hist_bin_fd(x, range):
    ...
    h : An estimate of the optimal bin width for the given data.
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_hist_bin_fd=199')
    del range
...
def _hist_bin_auto(x, range):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_hist_bin_auto=229')
...
def _ravel_and_check_weights(a, weights):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_ravel_and_check_weights=283')
    a = np.asarray(a)
    if a.dtype == np.bool_:
...
def _get_outer_edges(a, range):
    ...
    argument
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_get_outer_edges=304')
...
def _unsigned_subtract(a, b):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_unsigned_subtract=334')
...
def _get_bin_edges(a, bins, range, weights):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_get_bin_edges=360')
    n_equal_bins = None
    bin_edges = None
...
def _search_sorted_inclusive(a, v):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_search_sorted_inclusive=454')
    return np.concatenate((a.searchsorted(v[:-1], 'left'), a.searchsorted(v[-1:], 'right')))

def _histogram_bin_edges_dispatcher(a, bins=None, range=None, weights=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_histogram_bin_edges_dispatcher=466')
...
def histogram_bin_edges(a, bins=10, range=None, weights=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=histogram_bin_edges=470')
    (a, weights) = _ravel_and_check_weights(a, weights)
    (bin_edges, _) = _get_bin_edges(a, bins, range, weights)
    return bin_edges

def _histogram_dispatcher(a, bins=None, range=None, density=None, weights=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_histogram_dispatcher=673')
    return (a, bins, weights)
...
def histogram(a, bins=10, range=None, density=None, weights=None):
    ...
    *includes* 4.
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=histogram=678')
    (a, weights) = _ravel_and_check_weights(a, weights)
...
def _histogramdd_dispatcher(sample, bins=None, range=None, density=None, weights=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=_histogramdd_dispatcher=888')
...
def histogramdd(sample, bins=10, range=None, density=None, weights=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/histograms.py=histogramdd=899')
    try:
        (N, D) = sample.shape
