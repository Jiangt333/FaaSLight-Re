...
def _ediff1d_dispatcher(ary, to_end=None, to_begin=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=_ediff1d_dispatcher=33')
...
def ediff1d(ary, to_end=None, to_begin=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=ediff1d=37')
...
def _unpack_tuple(x):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=_unpack_tuple=125')
    if len(x) == 1:
        return x[0]
    else:
        return x
...
def _unique_dispatcher(ar, return_index=None, return_inverse=None, return_counts=None, axis=None, *, equal_nan=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=_unique_dispatcher=133')
    return (ar, )
...
def unique(ar, return_index=False, return_inverse=False, return_counts=False, axis=None, *, equal_nan=True):
    ...
    * the number of times each unique value comes up in the input array
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=unique=138')
    ar = np.asanyarray(ar)
    if axis is None:
    ...
    def reshape_uniq(uniq):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=unique=reshape_uniq=310')
        n = len(uniq)
...
def _unique1d(ar, return_index=False, return_inverse=False, return_counts=False, *, equal_nan=True):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=_unique1d=323')
...
def _intersect1d_dispatcher(ar1, ar2, assume_unique=None, return_indices=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=_intersect1d_dispatcher=368')
    return (ar1, ar2)
...
def intersect1d(ar1, ar2, assume_unique=False, return_indices=False):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=intersect1d=373')
...
def _setxor1d_dispatcher(ar1, ar2, assume_unique=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=_setxor1d_dispatcher=472')
    return (ar1, ar2)
...
def setxor1d(ar1, ar2, assume_unique=False):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=setxor1d=476')
    if not assume_unique:
        ar1 = unique(ar1)
        ar2 = unique(ar2)
    aux = np.concatenate((ar1, ar2))
...
def _in1d_dispatcher(ar1, ar2, assume_unique=None, invert=None, *, kind=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=_in1d_dispatcher=519')
    return (ar1, ar2)
...
def in1d(ar1, ar2, assume_unique=False, invert=False, *, kind=None):
    ...
    array([1, 5])
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=in1d=524')
...
def _isin_dispatcher(element, test_elements, assume_unique=None, invert=None, *, kind=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=_isin_dispatcher=761')
...
def isin(element, test_elements, assume_unique=False, invert=False, *, kind=None):
    ...
    array([[False,  True],
           [ True, False]])
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=isin=766')
    element = np.asarray(element)
    return in1d(element, test_elements, assume_unique=assume_unique, invert=invert, kind=kind).reshape(element.shape)

def _union1d_dispatcher(ar1, ar2):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=_union1d_dispatcher=894')
    return (ar1, ar2)
...
def union1d(ar1, ar2):
    ...
    array([1, 2, 3, 4, 6])
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=union1d=898')
    return unique(np.concatenate((ar1, ar2), axis=None))

def _setdiff1d_dispatcher(ar1, ar2, assume_unique=None):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=_setdiff1d_dispatcher=935')
    return (ar1, ar2)
...
def setdiff1d(ar1, ar2, assume_unique=False):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/lib/arraysetops.py=setdiff1d=939')
    if assume_unique:
        ar1 = np.asarray(ar1).ravel()
    else:
        ar1 = unique(ar1)
