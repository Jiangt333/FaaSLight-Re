...
def _checknames(descr, names=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=_checknames=45')
    ndescr = len(descr)
...
def _get_fieldmask(self):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=_get_fieldmask=79')
...
class MaskedRecords(MaskedArray):
    ...
    def __new__(cls, shape, dtype=None, buf=None, offset=0, strides=None, formats=None, names=None, titles=None, byteorder=None, aligned=False, mask=nomask, hard_mask=False, fill_value=None, keep_mask=True, copy=False, **options):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=__new__=104')
    ...
    def __array_finalize__(self, obj):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=__array_finalize__=144')
    ...
    def _data(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=_data=164')
    ...
    def _fieldmask(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=_fieldmask=172')
        return self._mask
    ...
    def __len__(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=__len__=180')
        if self.ndim:
            return len(self._data)
        return len(self.dtype)
    
    def __getattribute__(self, attr):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=__getattribute__=191')
        try:
    ...
    def __setattr__(self, attr, val):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=__setattr__=238')
    ...
    def __getitem__(self, indx):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=__getitem__=294')
    ...
    def __setitem__(self, indx, value):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=__setitem__=326')
    ...
    def __str__(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=__str__=335')
        if self.size > 1:
    ...
    def __repr__(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=__repr__=349')
    ...
    def view(self, dtype=None, type=None):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=view=362')
        if dtype is None:
            if type is None:
    ...
    def harden_mask(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=harden_mask=402')
        self._hardmask = True
    ...
    def soften_mask(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=soften_mask=409')
    ...
    def copy(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=copy=416')
    ...
    def tolist(self, fill_value=None):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=tolist=425')
    ...
    def __getstate__(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=__getstate__=441')
    ...
    def __setstate__(self, state):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=__setstate__=457')
    ...
    def __reduce__(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=MaskedRecords=__reduce__=477')
...
def _mrreconstruct(subtype, baseclass, baseshape, basetype):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=_mrreconstruct=487')
...
def fromarrays(arraylist, dtype=None, shape=None, formats=None, names=None, titles=None, aligned=False, byteorder=None, fill_value=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=fromarrays=504')
...
def fromrecords(reclist, dtype=None, shape=None, formats=None, names=None, titles=None, aligned=False, byteorder=None, fill_value=None, mask=nomask):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=fromrecords=547')
...
def _guessvartypes(arr):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=_guessvartypes=612')
    vartypes = []
    arr = np.asarray(arr)
    if arr.ndim == 2:
        arr = arr[0]
...
def openfile(fname):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=openfile=649')
...
def fromtextfile(fname, delimiter=None, commentchar='#', missingchar='', varnames=None, vartypes=None, *, delimitor=np._NoValue):
    ...
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=fromtextfile=669')
...
def addfield(mrecord, newfield, newfieldname=None):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/mrecords.py=addfield=749')
    _data = mrecord._data
    _mask = mrecord._mask
