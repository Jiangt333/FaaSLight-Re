...
def timer(s, v='', nloop=500, nrep=3):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/bench.py=timer=38')
    units = ['s', 'ms', 'µs', 'ns']
...
def compare_functions_1v(func, nloop=500, xs=xs, nmxs=nmxs, xl=xl, nmxl=nmxl):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/bench.py=compare_functions_1v=56')
...
def compare_methods(methodname, args, vars='x', nloop=500, test=True, xs=xs, nmxs=nmxs, xl=xl, nmxl=nmxl):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/bench.py=compare_methods=69')
    print('-' * 50)
...
def compare_functions_2v(func, nloop=500, test=True, xs=xs, nmxs=nmxs, ys=ys, nmys=nmys, xl=xl, nmxl=nmxl, yl=yl, nmyl=nmyl):
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/bench.py=compare_functions_2v=81')
    funcname = func.__name__
    print('-' * 50)
    print(f'{funcname} on small arrays')
