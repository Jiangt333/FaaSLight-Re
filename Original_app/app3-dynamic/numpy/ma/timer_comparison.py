...
class ModuleTester:
    ...
    def __init__(self, module):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/timer_comparison.py=ModuleTester=__init__=14')
        self.module = module
    ...
    def assert_array_compare(self, comparison, x, y, err_msg='', header='', fill_value=True):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/timer_comparison.py=ModuleTester=assert_array_compare=48')
        xf = self.filled(x)
        yf = self.filled(y)
    ...
    def assert_array_equal(self, x, y, err_msg=''):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/timer_comparison.py=ModuleTester=assert_array_equal=103')
    ...
    def test_0(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/timer_comparison.py=ModuleTester=test_0=111')
    ...
    def test_1(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/timer_comparison.py=ModuleTester=test_1=122')
        x = np.array([1.0, 1.0, 1.0, -2.0, pi / 2.0, 4.0, 5.0, -10.0, 10.0, 1.0, 2.0, 3.0])
    ...
    def test_2(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/timer_comparison.py=ModuleTester=test_2=150')
        x1 = np.array([1, 2, 4, 3])
    ...
    def test_3(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/timer_comparison.py=ModuleTester=test_3=193')
        x4 = self.arange(4)
        x4[2] = self.masked
        y4 = self.resize(x4, (8, ))
    ...
    def test_4(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/timer_comparison.py=ModuleTester=test_4=213')
        x = self.arange(24)
        y = np.arange(24)
        x[5:6] = self.masked
        x = x.reshape(2, 3, 4)
    ...
    def test_5(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/timer_comparison.py=ModuleTester=test_5=237')
        x = self.arange(10)
        y = self.arange(10)
        xm = self.arange(10)
        xm[2] = self.masked
    ...
    def test_6(self):
        ...
        """
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/timer_comparison.py=ModuleTester=test_6=290')
    ...
    def test_7(self):
        """Tests ufunc"""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/timer_comparison.py=ModuleTester=test_7=342')
    ...
    @np.errstate(all='ignore')
    def test_99(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/timer_comparison.py=ModuleTester=test_99=377')
    ...
    @np.errstate(all='ignore')
    def test_A(self):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/timer_comparison.py=ModuleTester=test_A=423')
        x = self.arange(24)
        x[5:6] = self.masked
        x = x.reshape(2, 3, 4)
