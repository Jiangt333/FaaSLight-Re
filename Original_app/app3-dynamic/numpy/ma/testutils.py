...
def approx(a, b, fill_value=True, rtol=1e-05, atol=1e-08):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=approx=41')
...
def almost(a, b, decimal=6, fill_value=True):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=almost=63')
    m = mask_or(getmask(a), getmask(b))
    d1 = filled(a)
    d2 = filled(b)
    if (d1.dtype.char == 'O' or d2.dtype.char == 'O'):
...
def _assert_equal_on_sequences(actual, desired, err_msg=''):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=_assert_equal_on_sequences=82')
...
def assert_equal_records(a, b):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=assert_equal_records=93')
...
def assert_equal(actual, desired, err_msg=''):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=assert_equal=108')
...
def fail_if_equal(actual, desired, err_msg=''):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=fail_if_equal=147')
    if isinstance(desired, dict):
        if not isinstance(actual, dict):
            raise AssertionError(repr(type(actual)))
...
def assert_almost_equal(actual, desired, decimal=7, err_msg='', verbose=True):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=assert_almost_equal=176')
    if (isinstance(actual, np.ndarray) or isinstance(desired, np.ndarray)):
...
def assert_array_compare(comparison, x, y, err_msg='', verbose=True, header='', fill_value=True):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=assert_array_compare=195')
    ...
    if ((x is masked and not y is masked) or (y is masked and not x is masked)):
        ...
        raise ValueError(msg)
    return np.testing.assert_array_compare(comparison, x.filled(fill_value), y.filled(fill_value), err_msg=err_msg, verbose=verbose, header=header)
...
def assert_array_equal(x, y, err_msg='', verbose=True):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=assert_array_equal=220')
...
def fail_if_array_equal(x, y, err_msg='', verbose=True):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=fail_if_array_equal=230')
    
    def compare(x, y):
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=fail_if_array_equal=compare=235')
...
def assert_array_approx_equal(x, y, decimal=6, err_msg='', verbose=True):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=assert_array_approx_equal=241')
    
    def compare(x, y):
        """Returns the result of the loose comparison between x and y)."""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=assert_array_approx_equal=compare=248')
...
def assert_array_almost_equal(x, y, decimal=6, err_msg='', verbose=True):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=assert_array_almost_equal=255')
    
    def compare(x, y):
        """Returns the result of the loose comparison between x and y)."""
        print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=assert_array_almost_equal=compare=262')
...
def assert_array_less(x, y, err_msg='', verbose=True):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=assert_array_less=269')
...
def assert_mask_equal(m1, m2, err_msg=''):
    ...
    """
    print('/home/jiangt/FaaSLight-Re/Original_app/app3-dynamic/numpy/ma/testutils.py=assert_mask_equal=279')
    if m1 is nomask:
